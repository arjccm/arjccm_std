 ...
 * @author 34393
 * @title: Pagecount
 * @description: 分页不查询总数  人口管理 实有人口 常住人口  房屋管理  地址库管理
 * @date 2020/3/1713:13
 */
public class Pagecount<T> {
    ...
    public Pagecount(HttpServletRequest request, HttpServletResponse response) {
        this(request, response, -2);
    }

    public Pagecount(HttpServletRequest request, HttpServletResponse response, int defaultPageSize) {
        this.pageNo = 1;
        this.pageSize = Integer.valueOf(Global.getConfig("page.pageSize"));
        this.length = 8;
        this.slider = 1;
    ...
    public Pagecount(int pageNo, int pageSize) {
        this(pageNo, pageSize, 0L);
    }

    public Pagecount(int pageNo, int pageSize, long count) {
        this(pageNo, pageSize, count, new ArrayList());
    }

    public Pagecount(int pageNo, int pageSize, long count, List<T> list) {
        this.pageNo = 1;
        this.pageSize = Integer.valueOf(Global.getConfig("page.pageSize"));
        this.length = 8;
        this.slider = 1;
...
//        }
        ...
        sb.append(this.funcName + "(this.value," + this.pageSize + ",'" + this.funcParam + "');\" onclick=\"this.select();\"/> 页，&nbsp;每页 ");
...
//        sb.append("共 " + this.count + " 条" + (this.message != null ? this.message : "") + "</a></li>\n");
        sb.append((this.message != null ? this.message : "") + "</a></li>\n");
        sb.insert(0, "<ul>\n").append("</ul>\n");
    ...
    public Pagecount<T> setList(List<T> list) {
        this.list = list;
        this.initialize();
        return this;
    }

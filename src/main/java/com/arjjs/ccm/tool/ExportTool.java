...
public class ExportTool {
    ...
    @ExcelField(title="", align=2, sort=1)
    ...
    @ExcelField(title="", align=2, sort=3)
    ...
    @ExcelField(title="", align=2, sort=4)
    ...
    @ExcelField(title="", align=2, sort=5)
    ...
    @ExcelField(title="", align=2, sort=6)
    ...
    @ExcelField(title="", align=2, sort=7)
    ...
    @ExcelField(title="", align=2, sort=8)
    ...
    @ExcelField(title="", align=2, sort=9)
    ...
    @ExcelField(title="", align=2, sort=11)
    ...
    @ExcelField(title="", align=2, sort=13)
    ...
    @ExcelField(title="", align=2, sort=14)
    ...
    @ExcelField(title="", align=2, sort=16)
    ...
    @ExcelField(title="", align=2, sort=17)
    ...
    @ExcelField(title="", align=2, sort=18)
    ...
    @ExcelField(title="", align=2, sort=19)

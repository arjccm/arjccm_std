...
public class CcmOrgAreaController extends BaseController {
	...
	@RequestMapping(value = "getPeopleNum",method = RequestMethod.GET)
	@ResponseBody
	public Integer getPeopleNum(String id) {

		return ccmOrgAreaService.getPeopleNum(id);
	}
	@RequestMapping(value = "getkeyPeopleNum",method = RequestMethod.GET)
	@ResponseBody
	public Integer getkeyPeopleNum(String id) {

		return 	ccmOrgAreaService.getkeyPeopleNum(id);
	}
}
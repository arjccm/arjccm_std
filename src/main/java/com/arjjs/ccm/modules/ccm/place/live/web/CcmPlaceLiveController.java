 ...
 */
package com.arjjs.ccm.modules.ccm.place.live.web;
...
public class CcmPlaceLiveController extends BaseController {
	...
	public String list(CcmPlaceLive ccmPlaceLive, HttpServletRequest request, HttpServletResponse response, Model model,
		...
		if ("1".equals(type)) {
			return "ccm/place/live/ccmPlaceLiveList";
		}
		if ("2".equals(type)) {
			return "ccm/place/live/ccmPlaceToiletList";
		}
		if ("3".equals(type)) {
			return "ccm/place/live/ccmPlaceLiveHallList";
		}
		return "ccm/place/live/ccmPlaceLiveList";
	}
	...
	public String form1(CcmPlaceLive ccmPlaceLive, Model model) {
		...
		if ("1".equals(ccmPlaceLive.getType())) {
			return "ccm/place/live/ccmPlaceLiveForm";
		}
		if ("2".equals(ccmPlaceLive.getType())) {
			return "ccm/place/live/ccmPlaceToiletForm";
		}
		if ("3".equals(ccmPlaceLive.getType())) {
			return "ccm/place/live/ccmPlaceLiveHallForm";
		}
		return "ccm/place/live/ccmPlaceLiveForm";
	}

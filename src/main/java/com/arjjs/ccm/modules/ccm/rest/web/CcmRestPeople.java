...
/*		ccmPop.setIsAids(1);*/
	...
	public CcmRestResult save(CcmPeopleAntiepidemic ccmPeopleAntiepidemic) {
		...
		if(StringUtils.isNotEmpty(ccmPeopleAntiepidemic.getIdNumber())){
		    String idCard = ccmPeopleAntiepidemic.getIdNumber();
            String birthDate = idCard.substring(6,10)+"-"+idCard.substring(10,12)+"-"+idCard.substring(12,14);
            int age = getAgefromBirthTime(birthDate);
			ccmPeopleAntiepidemic.setAge(age);
		}

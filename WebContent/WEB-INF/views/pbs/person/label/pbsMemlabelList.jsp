			...
			<c:forEach items="${page.list}" var="pbsMemlabel">
				<tr>
					...
					<shiro:hasPermission name="person:pbsMemlabel:edit">
						...
						<a href="${ctx}/person/pbsMemlabel/delete?id=${pbsMemlabel.id}" onclick="return confirmx('确认要删除该课程信息吗？', this.href)" title = "删除"><i class="icon iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a></td>
					</shiro:hasPermission>
				</tr>
			</c:forEach>
		</tbody>

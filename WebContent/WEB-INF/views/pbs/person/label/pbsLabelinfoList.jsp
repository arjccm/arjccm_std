				...
				<tr>
					...
					<shiro:hasPermission name="person:pbsLabelinfo:edit">
						<td>
							...
							<a href="${ctx}/person/pbsLabelinfo/delete?id=${pbsLabelinfo.id}" onclick="return confirmx('确认要删除该建议分区吗？', this.href)" title = "删除"><i class="icon iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>
						</td>
					</shiro:hasPermission>
				</tr>
			</c:forEach>

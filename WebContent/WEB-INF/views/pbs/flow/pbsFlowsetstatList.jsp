		...
		<c:forEach items="${page.list}" var="pbsFlowsetstat">
			<tr>
				...
				<shiro:hasPermission name="flow:pbsFlowsetstat:edit"><td>
					...
					<a href="${ctx}/flow/pbsFlowsetstat/delete?id=${pbsFlowsetstat.id}" onclick="return confirmx('确认要删除该节点操作后吗？', this.href)" title = "删除"><i class="icon iconfont icon-caozuotubiao-shanchu"></i></a>

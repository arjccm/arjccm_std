		...
		<c:forEach items="${page.list}" var="pbsApplyrec">
			<tr>
				...
				<shiro:hasPermission name="apply:pbsApplyrec:edit"><td>
					...
					<a href="${ctx}/apply/pbsApplyrec/delete?id=${pbsApplyrec.id}" onclick="return confirmx('确认要删除该申请记录吗？', this.href)" title = "删除"><i class="icon iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

		...
		<c:forEach items="${page.list}" var="pbsExamactionitem">
			<tr>
				...
				<shiro:hasPermission name="exam:pbsExamactionitem:edit"><td>
					...
					<a href="${ctx}/exam/pbsExamactionitem/delete?id=${pbsExamactionitem.id}" onclick="return confirmx('确认要删除该考试题目信息吗？', this.href)" title = "删除"><i class="icon iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

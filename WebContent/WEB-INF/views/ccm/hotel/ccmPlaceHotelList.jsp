				...
				<tr>
					...
					<shiro:hasPermission name="hotel:ccmPlaceHotel:edit">
						<td>
							...
							<a class="btnList"
							   onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/toaddPeople?placeOrgId=${ccmPlaceHotel.id}&type=1', '从业人员添加', '1550px', '800px')"
							   title="从业人员添加"><i class="icon-plus"></i></a>
							<a class="btnList"
							   onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceHotel.id}&type=1', '从业人员信息', '1550px', '800px')"

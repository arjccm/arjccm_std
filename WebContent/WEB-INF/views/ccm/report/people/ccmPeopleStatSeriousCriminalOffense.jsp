...
<div class="back-list clearfix">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatSeriousCriminalOffense">数据统计</a></li>
		<shiro:hasPermission name="house:ccmSeriousCriminalOffense:view"><li><a style="text-align:center" href="javascript:;" data-href="${ctx}/house/ccmSeriousCriminalOffense" onclick="HasSecret(this)">数据列表</a></li></shiro:hasPermission>
	</ul>

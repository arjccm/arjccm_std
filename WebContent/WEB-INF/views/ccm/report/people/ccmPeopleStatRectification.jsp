...
<div class="back-list">
	...
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="house:ccmHouseRectification:view"><li><a  style="width: 140px;text-align:center"  href="javascript:;" data-href="${ctx}/house/ccmHouseRectification" onclick="HasSecret(this)">数据列表</a></li></shiro:hasPermission>
	</ul>
	<div class="row-fluid">

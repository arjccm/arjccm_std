...
<div class="back-list clearfix">
    ...
    <ul class="nav nav-tabs">
        <li class="active" style="width: 140px"><a class="nav-head"
                                                   href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatRectification">数据统计</a>
        </li>
        <shiro:hasPermission name="house:ccmHouseRectification:view">
            <li><a style="width: 140px;text-align:center" href="javascript:;"
                   data-href="${ctx}/house/ccmHouseRectification" onclick="HasSecret(this)">数据列表</a></li>
        </shiro:hasPermission>
    </ul>

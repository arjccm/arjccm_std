...
<input type="hidden" id="hasPermission" value="${fns:getUser().hasPermission}"/>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatAids">数据统计</a></li>
		<shiro:hasPermission name="house:ccmHouseAids:view"><li><a style="text-align:center" href="javascript:;" data-href="${ctx}/house/ccmHouseAids" onclick="HasSecret(this)">数据列表</a></li></shiro:hasPermission>
	</ul>

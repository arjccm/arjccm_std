...
<div class="back-list">
    ...
    <ul class="nav nav-tabs">
        <li class="active" style="width: 140px"><a class="nav-head"
                                                   href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatHarmNational">数据统计</a>
        </li>
        <li><a style="width: 140px;text-align:center" href="javascript:;"
               data-href="${ctx}/house/ccmHarmNationalSecurity" onclick="HasSecret(this)">数据列表</a></li>
    </ul>
    <div class="row-fluid">

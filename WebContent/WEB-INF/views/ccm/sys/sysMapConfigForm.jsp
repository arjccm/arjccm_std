...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/sys/sysConfig/mapConfigForm">地图信息配置</a></li>
    </ul>
    <!--<sys:message content="${message}"/>	-->
    <!-- 系统应用级别 -->
    <form:form id="inputFormSystemMapConfig" modelAttribute="systemMapConfig"
               action="${ctx}/sys/sysConfig/saveMapConfigInfo" method="post" class="form-horizontal">
        <form:hidden path="id"/>
        <form:hidden path="remarks"/>
        <div class="control-group">
            <label class="control-label">默认显示：</label>
            <div class="controls">
                <form:radiobuttons path="sysMapConfig.showType" items="${fns:getDictList('url_type')}" itemLabel="label"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:radiobuttons path="sysMapConfig.projection" items="${fns:getDictList('projection_type')}"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="sysMapConfig.imageMapUrl" htmlEscape="false" maxlength="256"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="sysMapConfig.imgResolutions" htmlEscape="false" maxlength="500"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="sysMapConfig.imgOrigin" htmlEscape="false" maxlength="256"
                            class="input-xlarge number"/>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="sysMapConfig.imgTileSize" htmlEscape="false" maxlength="256"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="sysMapConfig.electronicMapUrl" htmlEscape="false" maxlength="256"
                            class="input-xlarge url"/>
            </div>
        </div>
        ...
        <div class="control-group">
            <label class="control-label">分辨率：</label>
            <div class="controls">
                <form:input path="sysMapConfig.elcResolutions" htmlEscape="false" maxlength="500"
                            class="input-xlarge number"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">原点：</label>
            <div class="controls">
                <form:input path="sysMapConfig.elcOrigin" htmlEscape="false" maxlength="256"
                            class="input-xlarge number"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">瓦片尺寸：</label>
            <div class="controls">
                <form:input path="sysMapConfig.elcTileSize" htmlEscape="false" maxlength="256"
                            class="input-xlarge digits"/>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <a id="btnCancel" class="btn  btn-back" href="javascript:;" onclick="history.go(-1)"><i
                    class="icon-reply"></i>返回</a>
        </div>
    </form:form>
</div>
</body>

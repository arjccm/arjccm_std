...
<%--		</c:if>--%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="beginDate" id="beginDate" type="text" readonly="readonly" disabled="true"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="endDate" id="endDate" type="text" readonly="readonly" maxlength="20" disabled="true"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="title" htmlEscape="false" maxlength="100" disabled="true"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="content" htmlEscape="false" rows="15" disabled="true"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden id="files" path="files" htmlEscape="false" disabled="true"

...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmEventOrganization" action="${ctx}/organization/ccmEventOrganization/"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <tr>
            ...
            <th>更新时间</th>
            <th>备注信息</th>
            <shiro:hasPermission name="organization:ccmEventOrganization:edit">
                <th>操作</th>
            </shiro:hasPermission>
        </tr>
        </thead>
        ...
        <c:forEach items="${page.list}" var="ccmEventOrganization">
            <tr>
                ...
                <td>
                    <a onclick="parent.parent.LayerDialog('${ctx}/organization/ccmEventOrganization/form?id=${ccmEventOrganization.id}', '修改', '700px', '700px')">
                ...
                <shiro:hasPermission name="organization:ccmEventOrganization:edit">
                    <td>
                        <a class="btnList"
                           onclick="parent.parent.LayerDialog('${ctx}/organization/ccmEventOrganization/form?id=${ccmEventOrganization.id}', '修改', '700px', '700px')"
                           title="修改">
                            <i class="iconfont icon-caozuotubiao-xiugai"></i>
                        </a>
                        <a class="btnList"
                           href="${ctx}/organization/ccmEventOrganization/delete?id=${ccmEventOrganization.id}"
                           onclick="return confirmx('确认要删除该调解组织吗？', this.href)" title="删除">

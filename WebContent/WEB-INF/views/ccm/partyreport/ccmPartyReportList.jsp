			...
			<tr>
				...
				<shiro:hasPermission name="partyreport:ccmPartyReport:edit"><td>
					...
					<a href="${ctx}/partyreport/ccmPartyReport/delete?id=${ccmPartyReport.id}" onclick="return confirmx('确认要删除该双报道情况管理吗？', this.href)">删除</a>--%>
						<a  class="btnList"
							onclick="parent.parent.parent.LayerDialog('${ctx}/partyreport/ccmPartyReport/form?id=${ccmPartyReport.id}', '修改', '1100px', '700px')"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a  class="btnList"
							href="${ctx}/partyreport/ccmPartyReport/delete?id=${ccmPartyReport.id}"
							onclick="return confirmx('确认要删除该双报道情况管理吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>

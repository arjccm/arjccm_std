...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmMobileDevice" action="${ctx}/ccmsys/ccmMobileDevice/save2" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="vSpecialPeople" name="vSpecialPeople.id" value="${ccmMobileDevice.vSpecialPeople.id}" labelName="vSpecialPeople.name" labelValue="${ccmMobileDevice.vSpecialPeople.name}"
								title="用户" url="/pop/ccmPeople/special" cssClass="" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="elecFenceInfo" name="elecFenceInfo.id" value="${ccmMobileDevice.elecFenceInfo.id}" labelName="elecFenceInfo.fenceName" labelValue="${ccmMobileDevice.elecFenceInfo.fenceName}"
								title="电子围栏" url="/fence/ccmElectronicFence/treeElecFence" cssClass="" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="control-group">

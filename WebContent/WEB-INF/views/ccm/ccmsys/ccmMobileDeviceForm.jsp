...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li><a style="text-align:center" href="${ctx}/ccmsys/ccmMobileDevice/">数据列表</a></li>
        <li class="active"><a class="nav-head"
                              href="${ctx}/ccmsys/ccmMobileDevice/form?id=${ccmMobileDevice.id}">数据<shiro:hasPermission
    ...
    <form:form id="inputForm" modelAttribute="ccmMobileDevice" action="${ctx}/ccmsys/ccmMobileDevice/save" method="post"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <sys:treeselect id="vCcmTeam" name="vCcmTeam.id" value="${ccmMobileDevice.vCcmTeam.id}"
                                labelName="vCcmTeam.name" labelValue="${ccmMobileDevice.vCcmTeam.name}"

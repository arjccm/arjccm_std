...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li><a style="text-align:center" href="${ctx}/ccmsys/ccmDevice/">数据列表</a></li>
        <li class="active"><a class="nav-head"
                              href="${ctx}/ccmsys/ccmDevice/form?id=${ccmDevice.id}">设备<shiro:hasPermission
                name="ccmsys:ccmDevice:edit">${not empty ccmDevice.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="ccmsys:ccmDevice:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <form:form id="inputForm" modelAttribute="ccmDevice" action="${ctx}/ccmsys/ccmDevice/save" method="post"
               class="form-horizontal">
        <form:hidden path="id"/>
        <sys:message content="${message}"/>

        <table border="0px"
               style="border-color: #CCCCCC; border: 0px solid #CCCCCC; width: 100%;border-top-color: white">
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>设备编号：</label>
                        <div class="controls">
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>设备名称：</label>
                        <div class="controls">
            ...
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>IP地址：</label>
                        <div class="controls">
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>端口：</label>
                        <div class="controls">
                            <form:input path="port" htmlEscape="false" maxlength="5"
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="sdkPort" htmlEscape="false" maxlength="5"
                                        class="input-xlarge required number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>通道号：</label>
                        <div class="controls">
                            <form:input path="channelNum" htmlEscape="false" maxlength="3"
                                        class="input-xlarge required number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>登陆账号：</label>
                        <div class="controls">
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font></span>设备类型：</label>
                        <div class="controls">
                            <form:select path="typeId" class="input-xlarge required">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('ccm_device_type_id')}" itemLabel="label"
            ...
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font></span>所属区域：</label>
                        <div class="controls">
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="status" class="input-xlarge ">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('ccm_device_status')}" itemLabel="label"
                                              itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </div>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>类型：</label>
                        <div class="controls">
                            <form:select path="typeVidicon" class="input-xlarge required">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('ccm_devicel_type_vidicon')}" itemLabel="label"
                                              itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </div>
                    </div>
            ...
            <tr>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select path="rangeType" class="input-xlarge required">
                                <form:options items="${fns:getDictList('installation_range_type')}" itemLabel="label"
                                              itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </div>
                    </div>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:textarea path="description" htmlEscape="false" rows="4" maxlength="1000"
                                           class="input-xxlarge "/>
                        </div>
                    </div>
                </td>
        ...
        <div class="form-actions">
            <shiro:hasPermission name="ccmsys:ccmDevice:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                     onclick="saveForm()"
                                                                     type="submit"

...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmPartyVolutterPost"
               action="${ctx}/partyvolutterpost/ccmPartyVolutterPost/" method="post" class="breadcrumb form-search">
        ...
        <ul class="ul-form">
            ...
            <li><label>所属社区：</label>
                <sys:treeselect id="community" name="community.id" value="${ccmPartyVolutterPost.community.id}"
                                labelName="community.name" labelValue="${ccmPartyVolutterPost.community.name}"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <tr>
            ...
            <th>联系人</th>
            <th>联系电话</th>
            <shiro:hasPermission name="partyvolutterpost:ccmPartyVolutterPost:edit">
                <th>操作</th>
            </shiro:hasPermission>
        </tr>
        </thead>
        ...
        <c:forEach items="${page.list}" var="ccmPartyVolutterPost">
            <tr>
                <td>
                    <a onclick="parent.parent.parent.LayerDialog('${ctx}/partyvolutterpost/ccmPartyVolutterPost/form?id=${ccmPartyVolutterPost.id}', '修改', '1100px', '700px')">
                ...
                <shiro:hasPermission name="partyvolutterpost:ccmPartyVolutterPost:edit">
                    <td>
                        ...
                        <a class="btnList"
                           onclick="parent.parent.parent.LayerDialog('${ctx}/partyvolutterpost/ccmPartyVolutterPost/form?id=${ccmPartyVolutterPost.id}', '修改', '1100px', '700px')"><i
                        ...
                        <a class="btnList"
                           ...
                           onclick="return confirmx('确认要删除该党员信息管理吗？', this.href)" title="删除"><i

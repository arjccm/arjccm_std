			...
			<tr>
				...
				<shiro:hasPermission name="partyactivity:ccmPartyActivity:edit"><td>
					...
					<a href="${ctx}/partyactivity/ccmPartyActivity/delete?id=${ccmPartyActivity.id}" onclick="return confirmx('确认要删除该党员活动管理吗？', this.href)">删除</a>--%>
						...
						<a  class="btnList"
							onclick="parent.parent.LayerDialog('${ctx}/partyactivity/ccmPartyActivity/form?id=${ccmPartyActivity.id}', '修改', '1100px', '700px')"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a  class="btnList"

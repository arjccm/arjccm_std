		...
		<c:forEach items="${page.list}" var="ccmLand">
			<tr>
				...
				<shiro:hasPermission name="citycomponents:ccmLand:edit"><td style="height: 50px">
					...
					<a class="btnList" href="${ctx}/citycomponents/ccmLand/delete?id=${ccmLand.id}" onclick="return confirmx('确认要删除该土地吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/citycomponents/ccmCityComponents/">数据列表</a></li>
		<shiro:hasPermission name="citycomponents:ccmCityComponents:edit"><li><a style="text-align:center" href="${ctx}/citycomponents/ccmCityComponents/form">数据添加</a></li></shiro:hasPermission>
	</ul>

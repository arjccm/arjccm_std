...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/service/ccmServiceCivil/">数据列表</a></li>
		<shiro:hasPermission name="service:ccmServiceCivil:edit"><li><a style="text-align:center" href="${ctx}/service/ccmServiceCivil/form">数据添加</a></li></shiro:hasPermission>
	</ul>

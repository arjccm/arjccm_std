...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li><a style="text-align:center" href="${ctx}/service/ccmServiceGuidance/">数据列表</a></li>
		<li class="active"><a class="nav-head" href="${ctx}/service/ccmServiceGuidance/form?id=${ccmServiceGuidance.id}">数据<shiro:hasPermission name="service:ccmServiceGuidance:edit">${not empty ccmServiceGuidance.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="service:ccmServiceGuidance:edit">查看</shiro:lacksPermission></a></li>
	</ul>

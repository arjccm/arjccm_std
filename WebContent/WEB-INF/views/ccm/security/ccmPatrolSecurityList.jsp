		...
		<c:forEach items="${page.list}" var="ccmPatrolSecurity">
			<tr>
				...
				<shiro:hasPermission name="security:ccmPatrolSecurity:edit"><td>
					...
					<a href="${ctx}/security/ccmPatrolSecurity/delete?id=${ccmPatrolSecurity.id}" onclick="return confirmx('确认要删除该警卫吗？', this.href)"><i style="color:red;" class="iconfont icon-icondaohangtubiao-shujucaijifenxi" title="删除"></i></a>

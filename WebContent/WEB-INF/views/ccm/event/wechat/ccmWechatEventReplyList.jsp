...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmWechatEventReply" action="${ctx}/event/wechat/ccmWechatEventReply/"
        ...
        <ul class="ul-form">
            ...
            <li><label>消息回复状态：</label>
                <form:select path="status" class="input-medium">
                    ...
                    <form:options items="${fns:getDictList('ccm_wechat_event_reply_status')}" itemLabel="label"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <tr>
            ...
            <th>消息回复状态</th>
            <th>更新时间</th>
            <shiro:hasPermission name="event:wechat:ccmWechatEventReply:edit">
                <th>操作</th>
            </shiro:hasPermission>
        </tr>
        </thead>
        ...
        <c:forEach items="${page.list}" var="ccmWechatEventReply">
            <tr>
                ...
                <shiro:hasPermission name="event:wechat:ccmWechatEventReply:edit">
                    <td>
                        <a class="btnList"
                           href="${ctx}/event/wechat/ccmWechatEventReply/form?id=${ccmWechatEventReply.id}"
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
                        <a class="btnList"
                           href="${ctx}/event/wechat/ccmWechatEventReply/delete?id=${ccmWechatEventReply.id}"
                           onclick="return confirmx('确认要删除该微信信息回复吗？', this.href)" title="删除"><i

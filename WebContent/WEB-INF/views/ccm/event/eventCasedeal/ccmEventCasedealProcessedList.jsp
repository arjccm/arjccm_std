...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmEventCasedeal"
        ...
        <ul class="ul-form">
            ...
            <li><label>处理措施：</label> <form:input path="handleStep" htmlEscape="false" maxlength="64"
        ...
        <c:forEach items="${page.list}" var="ccmEventCasedeal">
            <tr>
                ...
                <td>
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/event/ccmEventCasedeal/form?id=${ccmEventCasedeal.id}','处理', '1200px', '700px')"><i

...
<div class="back-list clearfix">
    ...
    <ul class="nav nav-tabs">
        ...
        <li style="float:right;"><a class="nav-head"
                                    href="${ctx}/event/ccmEventCasedeal/?handleStatus=05" style="color: #25cf71;">已办事件</a></li>
        <li style="float:right;"><a class="nav-head"
        ...
        <ul class="ul-form">
            ...
            <li><label>分类：</label>
                <form:select path="objType" class="input-medium">
                    ...
                    <form:options items="${fns:getDictList('ccm_event_obj_table')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </li>
            <li><label>事件状态：</label>
            ...
            <li><label>任务处理状态：</label>
                <form:select path="handleStatus" class="input-medium">
                    <form:option value="" label="全部"/>
                    <form:options items="${fns:getDictList('ccm_task_status')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </li>
        ...
        <c:forEach items="${page.list}" var="ccmEventCasedeal">
            <tr>
                ...
                <td>
                    ...
                    <a class="btnList" title="事件处理"><i class="iconfont icon-caozuotubiao-xiugai"
                    ...
                    <a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmEventCasedeal.objId}')"
                       title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
                    <c:if test="${ccmEventCasedeal.handleStatus eq '01'}">
                    <a class="btnList" onclick="HandleTips(this,'${ccmEventCasedeal.id}')" title="签收"><i
                            class="iconfont icon-caozuotubiao-qianshou"></i></a>
                    </c:if>
                    </shiro:hasPermission>
            </tr>
        </c:forEach>

...
<%--&lt;%&ndash;        <c:if name="event:ccmEventIncident:edit">&ndash;%&gt;--%>
...
<%--&lt;%&ndash;        ${not empty ccmEventIncident.id?${isDispatch eq 1}?'指派':'修改':'添加'}&ndash;%&gt;--%>
<%--        </shiro:hasPermission>--%>
                ...
                <div>
                    ...
                    <div class="controls">
                        <sys:treeselect id="area" name="area.id"
                                        value="${ccmEventIncident.area.id}" labelName="area.name" disabled="true"
                ...
                <div>
                    ...
                    <div class="controls">
                        <input name="happenDate" type="text"
                               readonly="readonly" maxlength="20" class="input-medium Wdate disabled1 required" disabled="true"
        ...
        <tr>
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div class="controls">
                        <form:input path="address" htmlEscape="false" maxlength="6"  disabled="true" class="disabled1 input-xlarge"/>
                    </div>
                </div>
            </td>
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
        ...
        <tr>
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div  class="controls">
                        <form:select onchange="xianLu(this.value)" path="eventKind" disabled="true" class="input-xlarge disabled1 required" style="width:284px">
            ...
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div class="controls">
                        <form:input path="number" htmlEscape="false" disabled="true"
        ...
        <tr>
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div class="controls">
                        <form:select path="eventSort" class="input-xlarge disabled1 required" disabled="true" style="width:284px">
            ...
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div class="controls">
                        <form:select path="caseScope" class="input-xlarge disabled1 required" disabled="true" style="width:284px">
        ...
        <tr>
            ...
            <td style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div class="controls">
                        <form:input path="areaPoint" readonly="true" htmlEscape="false" disabled="true"
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:radiobuttons path="eventScale"
                                           items="${fns:getDictList('ccm_case_grad')}" itemLabel="label" disabled="true"
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:radiobuttons path="typeSolve"
                                           items="${fns:getDictList('yes_no')}" itemLabel="label" disabled="true"
        ...
        <tr id="xianlu" hidden="hidden">
            <td colspan="2" style="padding: 8px;border: 0px dashed #CCCCCC">
                <div>
                    ...
                    <div class="controls">
                        <sys:treeselect id="line" name="line.id" value="${ccmEventIncident.line.id}" disabled="true"
            ...
            <tr>
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="property" class="input-xlarge disabled1 required" disabled="true" style="width:284px">
                ...
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="eventType" class="input-xlarge disabled1 required" disabled="true" style="width:284px">
            ...
            <tr>
                ...
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:radiobuttons path="historyLegacy" disabled="true"
            ...
            <tr>
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:radiobuttons path="stick" disabled="true"
                                               items="${fns:getDictList('yes_no')}" itemLabel="label"
                                               itemValue="value" htmlEscape="false" class="disabled1"/>
                        </div>
                    </div>
                ...
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:radiobuttons path="urgent" items="${fns:getDictList('yes_no')}" itemLabel="label" disabled="true"
                                               itemValue="value" htmlEscape="false" class="disabled1"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="culPaperid" id="styleType" disabled="true"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <input name="caseOverDay" type="text"
                                   readonly="readonly" maxlength="20" class="input-medium disabled1 Wdate " disabled="true"
            ...
            <tr>
                ...
                <td style="padding: 8px;border: 0px dashed #CCCCCC">
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="status" class="input-xlarge disabled1" disabled="true" style="width:284px">

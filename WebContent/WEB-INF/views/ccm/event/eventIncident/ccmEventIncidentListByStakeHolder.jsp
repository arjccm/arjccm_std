...
<div class="context" content="${ctx}"></div>
	<ul class="nav nav-tabs">
		<li><a class="nav-head" href="${ctx}/event/ccmEventStakeholder/list?incidentId=${incidentId}">数据列表</a></li>
		...
		<li class="active"><a class="nav-head" href="${ctx}/event/ccmEventStakeholder/getEventListByStakeholder?stakeHolderIden=${ccmEventStakeholder.idenNum}&incidentId=${incidentId}">涉及案（事）件列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="ccmEventIncident"
		action="${ctx}/event/ccmEventStakeholder/getEventListByStakeholder?stakeHolderIden=${stakeHolderIden}" method="post"
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmEventIncident">
				<tr>
					...
					<td><a href="${ctx}/event/ccmEventStakeholder/getEventCasedealById?id=${ccmEventIncident.id}&stakeHolderIden=${stakeHolderIden}&incidentId=${incidentId}">
...
<%--					<td>${fns:getDictLabel(ccmEventIncident.property, 'ccm_case_natu', '')}</td>--%>
					...
					<td>
						...
						<shiro:hasPermission name="event:ccmEventIncident:edit">
							<a  class="btnList"
								href="${ctx}/event/ccmEventStakeholder/getEventCasedealById?id=${ccmEventIncident.id}&stakeHolderIden=${stakeHolderIden}&incidentId=${incidentId}" title="详情"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
							<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmEventIncident.id}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
						</shiro:hasPermission>
					</td>
				</tr>
			</c:forEach>

...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/event/ccmEventStakeholder/getEventListByStakeholder?stakeHolderIden=${stakeHolderIden}&incidentId=${incidentId}">涉及案（事）件列表</a></li>
    <li class="active"><a href="${ctx}/event/ccmEventStakeholder/getEventCasedealById?id=${ccmEventIncident.id}&stakeHolderIden=${stakeHolderIden}&incidentId=${incidentId}">涉及案（事）件详情</a></li>
</ul>

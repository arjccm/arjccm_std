...
<div class="context" content="${ctx}"></div>
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/event/ccmEventIncident/listMurder">数据列表</a></li>
	</ul>
				...
				<tr>
					...
					<td>
						<!-- 案（事）件登记编辑权限  --> <shiro:hasPermission
							...
							<a  class="btnList" 
								href="${ctx}/event/ccmEventIncident/formMurder?id=${ccmEventIncident.id}" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
							<a  class="btnList"
								href="${ctx}/event/ccmEventIncident/deleteMurder?id=${ccmEventIncident.id}"
								onclick="return confirmx('确认要删除该案案（事）件吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
						...
						<!--	<a class="btnList" href="${ctx}/event/ccmEventCasedeal/dealformMurder?eventIncidentId=${ccmEventIncident.id}" title="添加处理信息"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>    -->

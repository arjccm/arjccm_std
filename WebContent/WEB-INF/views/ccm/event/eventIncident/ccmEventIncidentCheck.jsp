    ...
    <ul class="ul-form">
        ...
        <li>
            ...
            <form:select path="eventScale" class="input-medium">
                ...
                <form:options items="${fns:getDictList('ccm_case_grad')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/>
            </form:select>
        </li>
        <li>
        ...
        <li class="second-line"><label>结束日期:</label> <input name="endHappenDate" type="text" readonly="readonly"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="ccmEventIncident">
        ...
        <tr>
			<td><input name="boxs" type="checkbox" value="${ccmEventIncident.id}" <c:forEach items="${byPlaceIdList}" var="byPlaceId">
				<c:if test="${ccmEventIncident.id eq byPlaceId.id}">checked</c:if>
			</c:forEach> /></td>

...
<%--					<td>${fns:getDictLabel(ccmEventIncident.property, 'ccm_case_natu', '')}</td>--%>
					...
					<td>
						<!-- 案（事）件登记编辑权限  --> <shiro:hasPermission
							...
							<a  class="btnList"
								href="${ctx}/event/ccmEventIncident/formLine?id=${ccmEventIncident.id}" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
							<a	class="btnList"
							...
							<!-- 
							<a class="btnList" href="${ctx}/event/ccmEventCasedeal/dealformLine?eventIncidentId=${ccmEventIncident.id}" title="添加处理信息"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>
							 -->

        ...
        <ul class="ul-form pull-left">
            ...
            <li class="second-line"> <%--style="padding-right: 300px;--%><label>发案地：</label>
                <sys:treeselect id="area" name="area.id" value="${ccmEventIncident.area.id}" labelName="area.name"
                                labelValue="${ccmEventIncident.area.name}" title="区域" url="/sys/area/treeData"
                                cssClass=""
        ...
        <div class="clearfix pull-right btn-box">
            ...
            <shiro:hasPermission name="event:ccmEventIncident:edit">
                <a class="btn btn-export" type="button"
                   ...
                   onclick="incident('historyLegacy')"><%--<i class="icon-tags"></i>--%><span
                        style="font-size: 12px">历史遗留</span></a>
                <a class="btn btn-export" type="button"
                ...
                <a class="btn btn-export" type="button"
                   ...
                   style="width: 49px; /*margin-top: 25px;*/display:inline-block;float: right;"
                   onclick="incident('stick')"><%--<i class="icon-pushpin"></i>--%><span
                        style="font-size: 12px">置顶</span></a>
                <a onclick="parent.LayerDialog('${ctx}/event/ccmEventIncident/form', '添加', '1200px', '800px')"
                        style="width: 49px;/*margin-top: 25px;*/display:inline-block;float: right;"
                        class="btn btn-export"><%--<i class="iconfont icon-caozuotubiao-tianjiachuli"></i> --%><span
                        style="font-size: 12px">添加</span></a>
            </shiro:hasPermission>

            <a href="javascript:;" id="btnSubmit"
               style="width: 49px;/*margin-top: 25px;*/display:inline-block;float: right;" class="btn btn-primary">
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmEventIncident">
            <tr>
                ...
                <td>
                    <img src="${ccmEventIncident.file1}"
                         class="pic-size pimg" <%--onclick="openPhoto('${ccmEventIncident.file1}')" --%>/>
                </td>
...
text-overflow: ellipsis; text-align: left;">
                ...
                <td>
                    ...
                    <a class="btnList"
                       ...
                       onclick="return confirmx('确认要删除该事件登记吗？', this.href)" title="删除"><i
                            class="iconfont icon-caozuotubiao-shanchu"></i></a>
                    <a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmEventIncident.id}')"
                       title="位置信息"><i
                    ...
                    <shiro:hasPermission name="event:ccmEventStakeholder:view">
                        ...
                        <a class="btnList"
                           onclick="parent.LayerDialog1('','${ctx}/event/ccmEventStakeholder/list?incidentId=${ccmEventIncident.id}', '干系人', '1680px', '700px')"
                    ...
                    <c:if test="${not empty ccmEventIncident.eventScale && ccmEventIncident.eventScale eq '03'}">
                        <a class="btnList nohover"><i class="iconfont icon-caozuotubiao-fasongjingqing"
                                                      style="cursor:not-allowed; color: #999999;"></i> </a>
                    </c:if>
                    ...
                    <c:if test="${empty ccmEventIncident.bphAlarmInfoId && (ccmEventIncident.eventScale eq '01' || ccmEventIncident.eventScale eq '02')}">
                        <a class="btnList" onclick="HandleTips(this,'${ccmEventIncident.id}')" title="发送警情"><i
                                class="iconfont icon-caozuotubiao-fasongjingqing" style="color: #1cdd1c;"></i></a>
                    </c:if>

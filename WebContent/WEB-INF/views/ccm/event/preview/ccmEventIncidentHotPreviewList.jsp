...
<ul class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li style="float: right;"><a id="yjj" class="nav-head"
			href="${ctx}/preview/ccmEventIncidentPreview/3?status=03" style="color: #ff3a47">已拒绝</a></li>
		<li style="float: right;"><a id="ycl" class="nav-head"
			href="${ctx}/preview/ccmEventIncidentPreview/3?status=02" style="color: #5dbabd">已处理</a></li>
		<li style="float: right;"><a id="wcl" class="nav-head"
			href="${ctx}/preview/ccmEventIncidentPreview/3?status=01" style="color: #dc9166">未处理</a></li>

...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li><a style="text-align:center"
               href="${ctx}/view/vCcmTeam/list?office.id=${office.id}&office.parentIds=,${office.id},">数据列表</a></li>
        <li class="active"><a class="nav-head" href="${ctx}/view/vCcmTeam/form?id=${vCcmTeam.id}">数据<shiro:hasPermission
                name="view:vCcmTeam:edit">${not empty vCcmTeam.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="view:vCcmTeam:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <form:form id="inputForm" modelAttribute="vCcmTeam" action="${ctx}/org/ccmOrgTeam/save" method="post"
               class="form-horizontal">
        <form:hidden path="id"/>
        <sys:message content="${message}"/>

        <table class="first_table" border="1px"
               style="border-color: #CCCCCC; border: 1px dashed #CCCCCC; padding: 10px; width: 100%;">
            <tr>
                <td rowspan="3">
                    <div>
				...
				<form:input path="photo" htmlEscape="false" maxlength="1000" class="input-xlarge " readonly="true"/>-->
                            <form:hidden id="images" path="photo" htmlEscape="false" maxlength="255"
                                         class="input-xlarge"/>
                            <sys:ckfinder input="images" type="images" uploadPath="/photo" selectMultiple="false"
                                          readonly="true" maxWidth="80" maxHeight="120"/>
                        </div>
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <label class="lbl"><fmt:formatDate value="${vCcmTeam.loginDate}" type="both"
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>机构名称：</label>
            ...
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>部门名称：</label>
        ...
        <table>
            <tr>
                <td style="padding-top: 15px">
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>人员类型：</label>
                        <div class="controls">
                            <form:select path="teamType" class="input-xlarge ">
                                <form:options items="${fns:getDictList('ccm_org_team_type')}" itemLabel="label"
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>级别：</label>
                        <div class="controls">
                            <form:select path="grade" class="input-xlarge required">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('ccm_sta_lev')}" itemLabel="label"
                                              itemValue="value" htmlEscape="false"/>
                            </form:select>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>职务：</label>
                        <div class="controls">
                            <form:select path="service" class="input-xlarge required">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('ccm_sta_dut')}" itemLabel="label"
                                              itemValue="value" htmlEscape="false"/>
                            </form:select>
        ...
        <div style="display:none">
            ...
            <div class="controls">
                <sys:treeselect id="user" name="user.id" value="${vCcmTeam.user.id}" labelName="user.name"
                                labelValue="${vCcmTeam.user.name}"
        ...
        <div class="form-actions">
            <shiro:hasPermission name="org:ccmOrgTeam:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"

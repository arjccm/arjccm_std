...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a class="nav-head"
                              href="${ctx}/broadcast/ccmDeviceBroadcast/form?id=${ccmDeviceBroadcast.id}">应急广播<shiro:hasPermission
                name="broadcast:ccmDeviceBroadcast:edit">${not empty ccmDeviceBroadcast.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="broadcast:ccmDeviceBroadcast:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <form:form id="inputForm" modelAttribute="ccmDeviceBroadcast" action="${ctx}/broadcast/ccmDeviceBroadcast/save"
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <sys:treeselect id="area" name="area.id" value="${ccmDeviceBroadcast.area.id}"
                                            labelName="area.name" labelValue="${ccmDeviceBroadcast.area.name}"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="status" class="input-xlarge ">
                                ...
                                <form:options items="${fns:getDictList('ccm_broadcast_status')}" itemLabel="label"
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:textarea path="param" htmlEscape="false" rows="4" maxlength="1000"
                                           class="input-xxlarge "/>
                        </div>
                    </div>
                </td>
        ...
        <div class="form-actions">
            <shiro:hasPermission name="broadcast:ccmDeviceBroadcast:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                                 type="submit"

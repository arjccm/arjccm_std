...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li><a style="text-align:center" href="${ctx}/work/ccmWorkAdvise/">数据列表</a></li>
        <li class="active"><a class="nav-head"
                              href="${ctx}/work/ccmWorkAdvise/form?id=${ccmWorkAdvise.id}">数据<shiro:hasPermission
                name="work:ccmWorkAdvise:edit">${not empty ccmWorkAdvise.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="work:ccmWorkAdvise:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <form:form id="inputForm" modelAttribute="ccmWorkAdvise" action="${ctx}/work/ccmWorkAdvise/save" method="post"
        ...
        <c:if test="${not empty ccmWorkAdvise.id}">
            <div class="control-group" style="padding-top: 8px">
                ...
                <div class="controls">
                    <input name="datas" type="text" readonly="readonly" maxlength="20"
        ...
        <div class="form-actions">
            <shiro:hasPermission name="work:ccmWorkAdvise:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                       type="submit"

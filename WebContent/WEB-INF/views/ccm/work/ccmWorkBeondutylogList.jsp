...
<div class="back-list clearfix">
    ...
    <ul class="ul-form pull-left">
        ...
        <li class="first-line"><label>结束日期：</label> <input name="endDatas" type="text" readonly="readonly"
        ...
        <li class="first-line"><label>记录类型：</label>
            <form:select path="type" class="input-medium">
                ...
                <form:options items="${fns:getDictList('ccm_work_beondutylog_type')}" itemLabel="label"
        ...
        <li class="second-line"><label>登记部门：</label>
            <sys:treeselect id="office" name="office.id" value="${ccmWorkBeondutylog.office.id}" labelName="office.name"
                            labelValue="${ccmWorkBeondutylog.office.name}"
                ...
                <shiro:hasPermission name="work:ccmWorkBeondutylog:edit">
                    <td>
                        ...
                        <a class="btnList" href="${ctx}/work/ccmWorkBeondutylog/delete?id=${ccmWorkBeondutylog.id}"
                           onclick="return confirmx('确认要删除该值班日志表吗？', this.href)" title="删除"><i

		...
		<c:forEach items="${page.list}" var="ccmWorkNotice">
			<tr>
				...
				<shiro:hasPermission name="work:ccmWorkNotice:edit"><td style="width:5%;height: 50px">
					...
					<a class="btnList" href="${ctx}/work/ccmWorkNotice/delete?id=${ccmWorkNotice.id}" onclick="return confirmx('确认要删除该公告吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

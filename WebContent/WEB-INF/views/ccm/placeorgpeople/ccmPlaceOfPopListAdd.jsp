...
<div class="context" content="${ctx}"></div>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${placeOrgId}&type=${type}">现有人员列表</a></li>
		<li class="active"><a href="${ctx}/placeorgpeople/ccmPlaceOrgPeople/listPopAdd?placeOrgId=${placeOrgId}&placeType=${type}">添加从业人员列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="ccmPeople" action="${ctx}/placeorgpeople/ccmPlaceOrgPeople/listPopAdd?placeOrgId=${placeOrgId}&placeType=${type}" method="post" class="breadcrumb form-search">
	...
	<script>
	function PopAdd(_this,peopleId,placeOrgId,type){
		var context = $(".context").attr("content");
		$.get(context+"/placeorgpeople/ccmPlaceOrgPeople/savePopAdd?peopleId="+peopleId+"&placeOrgId="+placeOrgId+"&type="+type+"",function(data){

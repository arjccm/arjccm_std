			...
			<c:forEach items="${page.list}" var="ccmHousePsychogeny">
				<tr>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHousePsychogeny:edit">
						...
						<a class="btnList" href="${ctx}/house/ccmHousePsychogeny/delete?id=${ccmHousePsychogeny.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该肇事肇祸等严重精神障碍患者吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

...
<!-- 导入、导出模块 -->
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="report:ccmPeopleStat:view"><li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatPsychogeny">数据统计</a></li></shiro:hasPermission>
		<li class="active"><a class="nav-head" href="javascript:;" data-href="${ctx}/house/ccmHousePsychogeny" onclick="HasSecret(this)">数据列表</a></li>
	</ul>
			...
			<c:forEach items="${page.list}" var="ccmHousePsychogeny">
				<tr>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHousePsychogeny:edit">
						...
						<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmHousePsychogeny.peopleId}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHousePsychogeny.peopleId}', '社交关系', '1000px', '700px')" title="社交关系"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
						<%-- <a class="btnList" onclick="parent.LayerDialog1('','${ctx}/work/ccmWorkTiming/form', '定时提醒', '700px', '500px')" title="定时提醒"><i class="iconfont icon-caozuotubiao-fasongjingqing"></i></a> --%>
			  			...
			  			<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHousePsychogeny.id}&relevance_table=ccm_house_psychogeny', '添加记录', '800px', '660px')"  title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>

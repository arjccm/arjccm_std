		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmHouseRelease">
				<tr>
					...
					<a class="btnList" href="${ctx}/house/ccmHouseRelease/delete?id=${ccmHouseRelease.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该安置帮教人员吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

...
<div class="context" content="${ctx}"></div>
	...
	<div id="importBox" class="hide">
		<form id="importForm" action="${ctx}/house/ccmHouseRelease/import" method="post" enctype="multipart/form-data" class="form-search" style="padding-left: 20px; text-align: center;" onsubmit="return saveImport()"><br />
			<input id="uploadFile" name="file" type="file" style="width: 330px" onchange="changeFalse(this.value.length)" /><br /> <br />
			<input id="btnImportSubmit" class="btn btn-primary" type="submit" value="导  入 " />
		</form>
	</div>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="report:ccmPeopleStat:view"><li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatRelease">数据统计</a></li></shiro:hasPermission>
		<li class="active"><a class="nav-head" href="javascript:;" data-href="${ctx}/house/ccmHouseRelease" onclick="HasSecret(this)">数据列表</a></li>
	</ul>
	...
	<div class="clearfix pull-right btn-box">
			...
			<shiro:hasPermission name="house:ccmHouseRelease:import">
            ...
            <shiro:hasPermission name="house:ccmHouseRelease:export">
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmHouseRelease">
				<tr>
					...
					<a class="btnList" onclick="parent.LayerDialog('${ctx}/house/ccmHouseRelease/form?id=${ccmHouseRelease.id}', '修改', '1200px', '900px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
					<a class="btnList" href="${ctx}/house/ccmHouseRelease/delete?id=${ccmHouseRelease.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该安置帮教人员吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmHouseRelease.peopleId}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
					<a class="btnList" onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHouseRelease.peopleId}', '社交关系', '1000px', '700px')" title="社交关系"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
					<%-- <a class="btnList" onclick="parent.LayerDialog1('','${ctx}/work/ccmWorkTiming/form', '定时提醒', '700px', '500px')" title="定时提醒"><i class="iconfont icon-caozuotubiao-fasongjingqing"></i></a> --%>
						...
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseRelease.id}&relevance_table=ccm_house_release', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i> </a>

		...
		<c:forEach items="${page.list}" var="ccmHouseHeresy">
			<tr>
				...
				<td class="tc"><shiro:hasPermission name="house:ccmHouseHeresy:edit">
					...
					<a class="btnList" href="${ctx}/house/ccmHouseHeresy/delete?id=${ccmHouseHeresy.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该涉教人员吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

			...
			<c:forEach items="${page.list}" var="ccmHouseDrugs">
				<tr>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHouseDrugs:edit">
							...
							<a class="btnList" href="${ctx}/house/ccmHouseDrugs/delete?id=${ccmHouseDrugs.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该吸毒人口吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

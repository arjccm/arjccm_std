...
<form:form id="inputForm" modelAttribute="ccmHouseAids" action="${ctx}/house/ccmHouseAids/save" method="post"
    ...
    <table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>感染途径：</label>
                    <div class="controls">
                        <form:select path="infeRoute" class="input-xlarge required">
                            <form:options items="${fns:getDictList('ccm_infe_rout')}" itemLabel="label"
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>是否有违法犯罪史：</label>
                    <div class="controls">
                        <form:radiobuttons path="crimPast" items="${fns:getDictList('yes_no')}" itemLabel="label"
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:select path="cateCase" class="input-xlarge ">
                            ...
                            <form:options items="${fns:getDictList('ccm_chag_type')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
                    </div>
                </div>
        ...
        <tr>
            ...
            <td>
                <div>
                    ...
                    <div class="controls">
                        <form:input path="helpTel" htmlEscape="false" maxlength="50"
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>收治情况：</label>
                    <div class="controls">
                        <form:select path="treaCase" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('ccm_tred_case')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>关注类型：</label>
                    <div class="controls">
                        <form:select path="attention" class="input-xlarge required">
                            <form:options items="${fns:getDictList('ccm_focu_type')}" itemtd="td" itemValue="value"
                                          htmlEscape="false"/>
                        </form:select>

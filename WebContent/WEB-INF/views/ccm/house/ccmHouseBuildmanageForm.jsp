...
<div class="back-list clearfix">
    ...
    <form:form id="inputForm" modelAttribute="ccmHouseBuildmanage" action="${ctx}/house/ccmHouseBuildmanage/save"
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <sys:treeselect id="area" name="area.id" value="${ccmHouseBuildmanage.area.id}"
                                            labelName="area.name" labelValue="${ccmHouseBuildmanage.area.name}"
                                            title="网格" url="/tree/ccmTree/treeDataArea?type=7&areaid=" cssClass=""
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="buildname" htmlEscape="false" maxlength="512"
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="floorArea" htmlEscape="false" maxlength="10"
                                        class="input-xlarge number positiveNumber "/>
                        </div>
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:hidden id="images" path="images" htmlEscape="false" maxlength="255"
                                         class="input-xlarge"/>
                            <sys:ckfinder input="images" type="images" uploadPath="/photo/LouDong"
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="buildNum" htmlEscape="false" maxlength="4" min="0"
                                        class="input-xlarge positiveNumber" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="buildPeo" htmlEscape="false" maxlength="6" class="input-xlarge digits"
                                        min="0" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="buildPname" htmlEscape="false" maxlength="64"
                                        class="input-xlarge required"/>
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="phone" htmlEscape="false" maxlength="12"
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <input name="birthday" type="text" readonly="readonly" onchange="initAge(this.value)"
                                   maxlength="20"
        ...
        <div class="form-actions">
            <shiro:hasPermission name="house:ccmHouseBuildmanage:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                              onclick="saveForm()" type="submit"

...
<div class="back-list clearfix">
	...
	<div id="importBox" class="hide">
		<form id="importForm" action="${ctx}/house/ccmSeriousCriminalOffense/import" method="post" enctype="multipart/form-data" class="form-search" style="padding-left: 20px; text-align: center;" onsubmit="return saveImport()"><br/>
			<input id="uploadFile" name="file" type="file" style="width: 330px" onchange="changeFalse(this.value.length)"/><br/><br/>
			<input id="btnImportSubmit"	class="btn btn-primary" type="submit" value="导  入 "/>
		</form>
	</div>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="report:ccmPeopleStat:view"><li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatSeriousCriminalOffense">数据统计</a></li></shiro:hasPermission>
		<li class="active"><a class="nav-head" href="javascript:;" data-href="${ctx}/house/ccmSeriousCriminalOffense" onclick="HasSecret(this)">数据列表</a></li>
	</ul>
	...
	<div class="clearfix pull-right btn-box">
			...
			<shiro:hasPermission name="house:ccmSeriousCriminalOffense:import">
        ...
        <shiro:hasPermission name="house:ccmSeriousCriminalOffense:export">
				...
				<tr>
					...
					<td class="tc">
						<shiro:hasPermission name="house:ccmSeriousCriminalOffense:edit">
							<a class="btnList" onclick="parent.LayerDialog('${ctx}/house/ccmSeriousCriminalOffense/form?id=${ccmSeriousCriminalOffense.id}', '修改', '1200px', '900px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
							<a class="btnList"
						...
						<shiro:hasPermission name="log:ccmLogTail:edit">
							<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmSeriousCriminalOffense.id}&relevance_table=ccm_serious_criminal_offense', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i> </a>
						</shiro:hasPermission>
					</td>
				</tr>
			</c:forEach>

...
<br/>
<form:form id="inputForm" modelAttribute="ccmHouseDrugs" action="${ctx}/house/ccmHouseDrugs/save" method="post"
    ...
    <table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>初次发现日期：</label>
                    <div class="controls">
                        <input name="firstFound" type="text" maxlength="20" class="input-medium Wdate required"
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>管控情况：</label>
                    <div class="controls">
                        <form:select path="contSit" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('ccm_cotl_case')}" itemLabel="label"
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>管控人姓名：</label>
                    <div class="controls">
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>管控人联系方式：</label>
                    <div class="controls">
                        <form:input path="contTl" htmlEscape="false" maxlength="50"
        ...
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>帮扶人姓名：</label>
                    <div class="controls">
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>帮扶人联系方式：</label>
                    <div class="controls">
                        <form:input path="helpTl" htmlEscape="false" maxlength="50"
                                    class="input-xlarge required phone"/>
            ...
            <td>
                <div>
                    ...
                    <div class="controls">
                        <form:radiobuttons path="crimPast" items="${fns:getDictList('have_no')}" itemLabel="label"
        ...
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>吸毒原因：</label>
                    <div class="controls">
                        <form:select path="drugCaus" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('sys_ccm_drugs_caus')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:select path="consDrug" class="input-xlarge ">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('sys_ccm_drugs_result')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
                    </div>
                </div>

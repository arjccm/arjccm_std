			...
			<c:forEach items="${page.list}" var="ccmHouseRelease">
				<tr>
					...
					<td><shiro:hasPermission name="house:ccmHouseRelease:edit">
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseRelease/form?id=${ccmHouseRelease.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>

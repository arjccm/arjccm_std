    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmHouseRelease">
            <tr>
                ...
                <td>
                    <a onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseRelease/form?id=${ccmHouseRelease.id}&hide1=true&hide2=false', '信息', '1200px', '800px')">${ccmHouseRelease.name}</a>
                </td>
                ...
                <td><shiro:hasPermission name="house:ccmHouseRelease:edit">
                    ...
                    <a class="btnList"
                       onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseRelease/form?id=${ccmHouseRelease.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')"

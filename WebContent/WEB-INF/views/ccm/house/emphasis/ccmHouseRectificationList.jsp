    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmHouseRectification">
            <tr>
                ...
                <td>
                    <a onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseRectification/form?id=${ccmHouseRectification.id}&hide1=true&hide2=false', '信息', '1200px', '800px')">${ccmHouseRectification.name}</a>
                </td>
                ...
                <td><shiro:hasPermission name="house:ccmHouseRectification:edit">
                    ...
                    <a class="btnList"
                       onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseRectification/form?id=${ccmHouseRectification.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')"

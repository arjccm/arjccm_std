		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmHouseEscape">
				<tr>
					...
					<c:if test="${ccmHouseEscape.atteType eq '04'}">
					...
					<td><shiro:hasPermission name="house:ccmHouseEscape:edit">
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseEscape/form?id=${ccmHouseEscape.id}', '修改', '1200px', '900px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/house/ccmHouseEscape/delete?id=${ccmHouseEscape.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该在逃人员吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
						<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmHouseEscape.peopleId}')" title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHouseEscape.peopleId}', '社交关系', '1000px', '700px')" title="社交关系"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
						<%-- <a class="btnList" onclick="parent.parent.LayerDialog1('','${ctx}/work/ccmWorkTiming/form', '定时提醒', '700px', '500px')" title="定时提醒"><i class="iconfont icon-caozuotubiao-fasongjingqing"></i></a> --%>
						</shiro:hasPermission> <shiro:hasPermission name="log:ccmLogTail:edit">
							<%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseEscape.id}&relevance_table=ccm_house_escape', '记录信息', '800px', '660px')" title="记录信息"><i class="iconfont icon-caozuotubiao-jiluxinxi" style="color: cornflowerblue;"></i></a> --%>
							<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseEscape.id}&relevance_table=ccm_house_escape', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i> </a>

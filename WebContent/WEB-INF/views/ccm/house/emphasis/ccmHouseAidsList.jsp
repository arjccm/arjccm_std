			...
			<c:forEach items="${page.list}" var="ccmHouseAids">
				<tr>
					...
					<td><shiro:hasPermission name="house:ccmHouseAids:edit">
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseAids/form?id=${ccmHouseAids.id}&hide1=true&hide2=false', '详情', '1200px', '800px')" title="详情"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseAids/form?id=${ccmHouseAids.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')" title="走访记录"><i class="iconfont icon-caozuotubiao-zoufangjilu"></i></a>
						...
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseAids.id}&relevance_table=ccm_house_aids', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>

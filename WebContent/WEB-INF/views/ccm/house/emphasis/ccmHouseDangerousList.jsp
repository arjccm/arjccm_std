    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmHouseDangerous">
            <tr>
                ...
                <td><a href=""></a><a
                        onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDangerous/form?id=${ccmHouseDangerous.id}&hide1=true&hide2=false', '信息', '1200px', '800px')">${ccmHouseDangerous.name}</a>
                </td>
                ...
                <td><shiro:hasPermission name="house:ccmHouseDangerous:edit">
                    ...
                    <a class="btnList"
                       onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDangerous/form?id=${ccmHouseDangerous.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')"

...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmHouseDangerous"
               action="${ctx}/house/ccmHouseDangerous/?tableType='ccmHouseDangerous'" method="post"
    ...
    <div class="clearfix pull-right btn-box">
        ...
        <a href="javascript:;"
           onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseEmphasis/listSet?type=ccmHouseDangerous', '通知信息设置', '550px', '250px')"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmHouseDangerous">
            <tr>
                ...
                <td><a href=""></a><a
                        onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDangerous/form?id=${ccmHouseDangerous.id}', '信息', '1200px', '800px')">${ccmHouseDangerous.name}</a>
                </td>
                ...
                <td><shiro:hasPermission name="house:ccmHouseDangerous:edit">
                    ...
                    <shiro:hasPermission name="log:ccmLogTail:edit">
                        <a class="btnList"
                           onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseDangerous.id}&relevance_table=ccm_house_dangerous', '走访记录', '1200px', '500px')"
                           title="走访记录"><i class="iconfont icon-caozuotubiao-zoufangjilu"></i></a>
                        <%-- <a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseDangerous.id}&relevance_table=ccm_house_dangerous', '记录信息', '800px', '660px')" title="记录信息"><i class="iconfont icon-caozuotubiao-jiluxinxi" style="color: cornflowerblue;"></i></a> --%>
                        <a class="btnList"
                           onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseDangerous.id}&relevance_table=ccm_house_dangerous', '添加记录', '800px', '660px')"

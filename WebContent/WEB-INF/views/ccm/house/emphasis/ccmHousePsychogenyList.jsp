...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmHousePsychogeny"
               action="${ctx}/house/ccmHousePsychogeny/?tableType='ccmHousePsychogeny'" method="post"
    ...
    <div class="clearfix pull-right btn-box">
        ...
        <a href="javascript:;"
           onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseEmphasis/listSet?type=ccmHousePsychogeny', '通知信息设置', '550px', '250px')"
        ...
        <c:forEach items="${page.list}" var="ccmHousePsychogeny">
            <tr>
                ...
                <td><shiro:hasPermission name="house:ccmHousePsychogeny:edit">
                        ...
                        <a class="btnList"
                           onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHousePsychogeny.id}&relevance_table=ccm_house_psychogeny', '走访记录', '1200px', '500px')"
                        ...
                        <a class="btnList"
                           onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHousePsychogeny.id}&relevance_table=ccm_house_psychogeny', '添加记录', '800px', '660px')"

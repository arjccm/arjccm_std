...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmHouseHeresy"
               action="${ctx}/house/ccmHouseHeresy/?tableType='ccmHouseHeresy'" method="post"
    ...
    <ul class="ul-form pull-left">
        ...
        <li class="first-line"><label>教派名称：</label> <form:input path="heresyName" htmlEscape="false" maxlength="64"
                                                                class="input-medium"/>
        </li>
        <!--
			<li><label>痴迷程度：</label>
        ...
        <c:forEach items="${page.list}" var="ccmHouseHeresy">
            <tr>
                ...
                <c:if test="${ccmHouseHeresy.atteType eq '01'}">
                    <td style='color:red'>${fns:getDictLabel(ccmHouseHeresy.atteType, 'ccm_conc_exte', '')}&nbsp; &nbsp;
                        <img src="${ctxStatic}/images/atteType_red.png"/></td>
                </c:if>
                <c:if test="${ccmHouseHeresy.atteType eq '02'}">
                    <td style='color:orange'>${fns:getDictLabel(ccmHouseHeresy.atteType, 'ccm_conc_exte', '')}&nbsp;
                        &nbsp; <img src="${ctxStatic}/images/atteType_orange.png"/></td>
                </c:if>
                <c:if test="${ccmHouseHeresy.atteType eq '03'}">
                    <td>${fns:getDictLabel(ccmHouseHeresy.atteType, 'ccm_conc_exte', '')}&nbsp; &nbsp; <img

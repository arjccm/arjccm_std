		...
		<c:forEach items="${page.list}" var="ccmHouseHeresy">
			<tr>
				...
				<shiro:hasPermission name="log:ccmLogTail:edit">
					...
					<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseHeresy.id}&relevance_table=ccm_house_heresy', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>

...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmHouseDeliberatelyIllegal"
               action="${ctx}/house/ccmHouseDeliberatelyIllegal/?tableType='ccmHouseDeliberatelyIllegal'" method="post"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmHouseDeliberatelyIllegal">
            <tr>
                ...
                <td>
                    <a onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDeliberatelyIllegal/form?id=${ccmHouseDeliberatelyIllegal.id}&hide1=true&hide2=false', '信息', '1200px', '900px')">${ccmHouseDeliberatelyIllegal.name}</a>
                </td>
                ...
                <td><shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:edit">
                    ...
                    <a class="btnList"
                       onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDeliberatelyIllegal/form?id=${ccmHouseDeliberatelyIllegal.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')"

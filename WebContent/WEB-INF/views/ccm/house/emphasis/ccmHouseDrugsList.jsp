			...
			<c:forEach items="${page.list}" var="ccmHouseDrugs">
				<tr>
					...
					<td><shiro:hasPermission name="house:ccmHouseDrugs:edit">
						...
						<a class="btnList" onclick="parent.parent.LayerDialog('${ctx}/house/ccmHouseDrugs/form?id=${ccmHouseDrugs.id}&hide1=false&hide2=true', '走访记录', '1200px', '500px')" title="走访记录"><i class="iconfont icon-caozuotubiao-zoufangjilu"></i></a>

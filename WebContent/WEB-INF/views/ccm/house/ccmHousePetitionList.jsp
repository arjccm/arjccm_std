		...
		<c:forEach items="${page.list}" var="ccmHousePetition">
			<tr>
				...
				<shiro:hasPermission name="house:ccmHousePetition:edit">
					...
					<a class="btnList" href="${ctx}/house/ccmHousePetition/delete?id=${ccmHousePetition.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该重点上访人员吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

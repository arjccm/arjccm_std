			...
			<c:forEach items="${page.list}" var="ccmHouseAids">
				<tr>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHouseAids:edit">
						...
						<a class="btnList" href="${ctx}/house/ccmHouseAids/delete?id=${ccmHouseAids.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该艾滋病危险人员吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

...
<!-- 导入、导出模块 -->
	<div id="importBox" class="hide">
		<form id="importForm" action="${ctx}/house/ccmHouseAids/import" method="post" enctype="multipart/form-data" class="form-search" style="padding-left: 20px; text-align: center;" onsubmit="return saveImport()"><br />
	...
	<div class="clearfix pull-right btn-box">
			...
			<shiro:hasPermission name="house:ccmHouseAids:import">
            ...
            <shiro:hasPermission name="house:ccmHouseAids:export">
		...
		<tbody>
			<c:forEach items="${page.list}" var="ccmHouseAids">
				<tr>
					...
					<c:if test="${ccmHouseAids.atteType eq '04'}">
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHouseAids:edit">
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/house/ccmHouseAids/form?id=${ccmHouseAids.id}', '修改', '1200px', '900px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/house/ccmHouseAids/delete?id=${ccmHouseAids.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该艾滋病危险人员吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
						<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmHouseAids.peopleId}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHouseAids.peopleId}', '社交关系', '1000px', '700px')" title="社交关系"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
						...
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseAids.id}&relevance_table=ccm_house_aids', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i> </a>

		...
		<c:forEach items="${page.list}" var="ccmHarmNationalSecurity">
			<tr>
				...
				<td class="tc"><shiro:hasPermission name="house:ccmHarmNationalSecurity:edit">
					...
					<a class="btnList" href="${ctx}/house/ccmHarmNationalSecurity/delete?id=${ccmHarmNationalSecurity.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该危害国家安全活动嫌疑人口吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

...
<!-- 导入、导出模块 -->
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="report:ccmPeopleStat:view"><li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatHarmNational">数据统计</a></li></shiro:hasPermission>
		...
		<c:forEach items="${page.list}" var="ccmHarmNationalSecurity">
			<tr>
				...
				<td class="tc"><shiro:hasPermission name="house:ccmHarmNationalSecurity:edit">
					<a class="btnList" onclick="parent.LayerDialog('${ctx}/house/ccmHarmNationalSecurity/form?id=${ccmHarmNationalSecurity.id}', '修改', '1200px', '900px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
					<a class="btnList" href="${ctx}/house/ccmHarmNationalSecurity/delete?id=${ccmHarmNationalSecurity.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该危害国家安全活动嫌疑人口吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmHarmNationalSecurity.peopleId}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
					<a class="btnList" onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHarmNationalSecurity.peopleId}', '社交关系', '1000px', '700px')" title="社交关系"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
					...
					<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHarmNationalSecurity.id}&relevance_table=ccm_harm_national_security', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>

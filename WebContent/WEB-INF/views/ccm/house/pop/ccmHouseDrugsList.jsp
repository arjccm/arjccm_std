			...
			<c:forEach items="${page.list}" var="ccmHouseDrugs">
				<tr>
					...
					<td><shiro:hasPermission name="house:ccmHouseDrugs:edit">
							...
							onclick="return confirmx('确认要删除该吸毒人口吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
							<a class="btnList"
								href="javascript:;" onclick="LocationOpen('${ccmHouseDrugs.peopleId}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>

...
<form:form id="inputForm" modelAttribute="ccmHouseDangerous" action="${ctx}/house/ccmHouseDangerous/save" method="post"
    ...
    <table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>工作单位：</label>
                    <div class="controls">
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>危险品类别：</label>
                    <div class="controls">
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>工作类别：</label>
                    <div class="controls">
                        <form:select path="workType" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('ccm_house_dangerous_work')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
                    </div>
                </div>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="house:ccmHouseDangerous:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                        type="submit"

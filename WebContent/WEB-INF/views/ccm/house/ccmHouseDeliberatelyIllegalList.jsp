...
<div class="back-list clearfix">
    ...
    <div id="importBox" class="hide">
        <form id="importForm" action="${ctx}/house/ccmHouseDeliberatelyIllegal/import" method="post"
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a class="nav-head" href="javascript:;" data-href="${ctx}/house/ccmHouseDeliberatelyIllegal"
                              onclick="HasSecret(this)">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmHouseDeliberatelyIllegal"
               action="${ctx}/house/ccmHouseDeliberatelyIllegal/" method="post" class="breadcrumb form-search clearfix">
    ...
    <div class="clearfix pull-right btn-box">
        ...
        <shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:import">
        ...
        <shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:export">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmHouseDeliberatelyIllegal">
            <tr>
                <td width="100px"><img src="${ccmHouseDeliberatelyIllegal.images}" style="height:50px;" class="pimg"/>
                </td>
                <td class="tc"><a
                        onclick="parent.LayerDialog('${ctx}/house/ccmHouseDeliberatelyIllegal/form?id=${ccmHouseDeliberatelyIllegal.id}', '信息', '1200px', '900px')">${ccmHouseDeliberatelyIllegal.name}</a>
                </td>
                ...
                <c:if test="${ccmHouseDeliberatelyIllegal.atteType eq '01'}">
                    <td style='color:red'>${fns:getDictLabel(ccmHouseDeliberatelyIllegal.atteType, 'ccm_conc_exte', '')}&nbsp;
                        &nbsp; <img src="${ctxStatic}/images/atteType_red.png"/></td>
                </c:if>
                <c:if test="${ccmHouseDeliberatelyIllegal.atteType eq '02'}">
                    <td style='color:orange'>${fns:getDictLabel(ccmHouseDeliberatelyIllegal.atteType, 'ccm_conc_exte', '')}&nbsp;
                ...
                <td class="tc"><shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:edit">
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/house/ccmHouseDeliberatelyIllegal/form?id=${ccmHouseDeliberatelyIllegal.id}', '修改', '1200px', '900px')"
                       title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
                    <a class="btnList"
                       href="${ctx}/house/ccmHouseDeliberatelyIllegal/delete?id=${ccmHouseDeliberatelyIllegal.id}&permissionKey=${permissionKey}"
                       onclick="return confirmx('确认要删除该故意犯法释放人口吗？', this.href)" title="删除"><i
                            class="iconfont icon-caozuotubiao-shanchu"></i></a>
                    <a class="btnList" href="javascript:;"
                       onclick="LocationOpen('${ccmHouseDeliberatelyIllegal.peopleId}')" title="位置信息"><i
                            class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHouseDeliberatelyIllegal.peopleId}', '社交关系', '1000px', '700px')"
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseDeliberatelyIllegal.id}&relevance_table=ccm_house_deliberatelyIllegal', '记录信息', '800px', '660px')"
                       title="记录信息"><i class="iconfont icon-caozuotubiao-jiluxinxi" style="color: cornflowerblue;"></i></a>
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseDeliberatelyIllegal.id}&relevance_table=ccm_house_deliberatelyIllegal', '添加记录', '800px', '660px')"

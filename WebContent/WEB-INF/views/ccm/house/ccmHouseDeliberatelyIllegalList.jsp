        ...
        <c:forEach items="${page.list}" var="ccmHouseDeliberatelyIllegal">
            <tr>
                ...
                <td class="tc"><shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:edit">
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmHouseDeliberatelyIllegal.id}&relevance_table=ccm_house_deliberately_llegal', '记录信息', '800px', '660px')"
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseDeliberatelyIllegal.id}&relevance_table=ccm_house_deliberately_llegal', '添加记录', '800px', '660px')"

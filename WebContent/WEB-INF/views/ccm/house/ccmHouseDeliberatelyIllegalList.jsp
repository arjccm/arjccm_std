			...
			<c:forEach items="${page.list}" var="ccmHouseDeliberatelyIllegal">
				<tr>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:edit">
						...
						<a class="btnList" href="${ctx}/house/ccmHouseDeliberatelyIllegal/delete?id=${ccmHouseDeliberatelyIllegal.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该故意犯法释放人口吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

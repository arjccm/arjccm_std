...
<!-- 导入、导出模块 -->
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="report:ccmPeopleStat:view"><li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatDeliberatelyIllegal">数据统计</a></li></shiro:hasPermission>
		<li class="active"><a class="nav-head" href="javascript:;" data-href="${ctx}/house/ccmHouseDeliberatelyIllegal" onclick="HasSecret(this)">数据列表</a></li>
	</ul>
			...
			<c:forEach items="${page.list}" var="ccmHouseDeliberatelyIllegal">
				<tr>
					...
					<td class="tc"><shiro:hasPermission name="house:ccmHouseDeliberatelyIllegal:edit">
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/house/ccmHouseDeliberatelyIllegal/form?id=${ccmHouseDeliberatelyIllegal.id}', '修改', '1200px', '900px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/house/ccmHouseDeliberatelyIllegal/delete?id=${ccmHouseDeliberatelyIllegal.id}&permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该故意犯法释放人口吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
						<a class="btnList" href="javascript:;" onclick="LocationOpen('${ccmHouseDeliberatelyIllegal.peopleId}')"  title="位置信息"><i class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmHouseDeliberatelyIllegal.peopleId}', '社交关系', '1000px', '700px')" title="社交关系"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
						...
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmHouseDeliberatelyIllegal.id}&relevance_table=ccm_house_deliberatelyIllegal', '添加记录', '800px', '660px')" title="添加记录"><i class="iconfont icon-caozuotubiao-tianjiachuli"></i></a>

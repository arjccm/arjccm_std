...
<form:form id="inputForm" modelAttribute="ccmHouseDeliberatelyIllegal"
           action="${ctx}/house/ccmHouseDeliberatelyIllegal/save" method="post" class="form-horizontal hide1">
    ...
    <table border="0px"
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>所判罪行：</label>
                    <div class="controls">
                        <form:input path="convictCrimes" htmlEscape="false" maxlength="50"
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>审判结果：</label>
                    <div class="controls">
                        <form:input path="convictResult" htmlEscape="false" maxlength="50"
                                    class="input-xlarge required"/>
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>违法时间：</label>
                    <div class="controls">
                        <input name="illegalDate" type="text" readonly="readonly" maxlength="20"
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>释放时间：</label>
                    <div class="controls">
                        <input name="acquittalDate" type="text" readonly="readonly" maxlength="20"
                               class="input-medium Wdate required"
        ...
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>是否累犯：</label>
                    <div class="controls">
                        <form:radiobuttons path="isRecidivism" items="${fns:getDictList('have_no')}" itemLabel="label"
                                           itemValue="value" htmlEscape="false" class="radiobuttons"/>
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div>
                    ...
                    <div class="controls">
                        <form:textarea path="illegalDescription" htmlEscape="false" rows="4" maxlength="1024"
                                       class="input-xlarge "/>
                    </div>
            ...
            <td>
                <div>
                    ...
                    <div class="controls">
                        <form:textarea path="reviewType" htmlEscape="false" rows="4" maxlength="2084"
                                       class="input-xlarge "/>
                    </div>
                </div>
            </td>

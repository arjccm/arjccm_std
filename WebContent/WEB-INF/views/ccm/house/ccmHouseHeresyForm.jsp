...
<form:form id="inputForm" modelAttribute="ccmHouseHeresy" action="${ctx}/house/ccmHouseHeresy/save" method="post"
    ...
    <table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>教派名称：</label>
                    <div class="controls">
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>痴迷程度：</label>
                    <div class="controls">
                        <form:select path="level" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('ccm_house_heresy_level')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>是否已转化：</label>
                    <div class="controls">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="house:ccmHouseHeresy:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                     type="submit"

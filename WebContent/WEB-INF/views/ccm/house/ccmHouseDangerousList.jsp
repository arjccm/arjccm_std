		...
		<c:forEach items="${page.list}" var="ccmHouseDangerous">
			<tr>
				...
				<td class="tc"><shiro:hasPermission name="house:ccmHouseDangerous:edit">
					...
					<a class="btnList" href="${ctx}/house/ccmHouseDangerous/delete?id=${ccmHouseDangerous.id}permissionKey=${permissionKey}" onclick="return confirmx('确认要删除该危险品从业人员吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

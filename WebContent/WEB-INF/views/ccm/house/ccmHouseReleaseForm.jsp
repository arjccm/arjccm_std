...
<form:form id="inputForm" modelAttribute="ccmHouseRelease" action="${ctx}/house/ccmHouseRelease/save" method="post"
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <form:radiobuttons path="recidivism" items="${fns:getDictList('yes_no')}" itemLabel="label"
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <input name="releDate" type="text" readonly="readonly" maxlength="20"
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>危险性评估类型：</label>
                <div class="controls">
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <input name="joinDate" type="text" readonly="readonly" maxlength="20"
                           class="input-medium Wdate required"
            ...
            <div>
                ...
                <div class="controls">
                    <form:select path="joinCond" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_gose_case')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <input name="placeDate" type="text" readonly="readonly" maxlength="20"
                           class="input-medium Wdate required"
            ...
            <div>
                ...
                <div class="controls">
                    <form:select path="placement" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_plam_case')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <form:radiobuttons path="reoffend" items="${fns:getDictList('yes_no')}" itemLabel="label"
                                       itemValue="value" htmlEscape="false" class="displayedbuttons required"/>
                </div>
            </div>
        </td>

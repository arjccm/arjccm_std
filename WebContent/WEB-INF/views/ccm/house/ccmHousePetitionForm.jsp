...
<br/>
<form:form id="inputForm" modelAttribute="ccmHousePetition" action="${ctx}/house/ccmHousePetition/save" method="post"
    ...
    <table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%;">
        ...
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>上访性质：</label>
                    <div class="controls">
                        <form:select path="petitionType" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('ccm_house_petition_type')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
                    </div>
                </div>
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>个或群访：</label>
                    <div class="controls">
                        <form:select path="peopleNumber" class="input-xlarge required">
                            <form:option value="" label=""/>
                            <form:options items="${fns:getDictList('ccm_house_petition_popnum')}" itemLabel="label"
                                          itemValue="value" htmlEscape="false"/>
                        </form:select>
                    </div>
                </div>
        ...
        <tr>
            <td>
                <div>
                    ...
                    <div class="controls">
                        <input name="firstTime" type="text" readonly="readonly" maxlength="20"
            ...
            <td>
                <div>
                    ...
                    <div class="controls">
                        <form:input path="petitionNum" htmlEscape="false" maxlength="10" class="input-xlarge  digits"
                                    type="number"/>
                    </div>
                </div>
            </td>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="house:ccmHousePetition:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                       type="submit"

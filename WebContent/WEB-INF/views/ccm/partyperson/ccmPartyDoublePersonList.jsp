			...
			<tr>
				...
				<shiro:hasPermission name="partyperson:ccmPartyPerson:edit"><td>
					...
					<a href="${ctx}/partyperson/ccmPartyPerson/delete?id=${ccmPartyPerson.id}" onclick="return confirmx('确认要删除该党员信息管理吗？', this.href)">删除</a>--%>
						<a  class="btnList"
							onclick="parent.parent.parent.LayerDialog('${ctx}/partyperson/ccmPartyPerson/form?id=${ccmPartyPerson.id}', '修改', '1330px', '800px')"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a  class="btnList"

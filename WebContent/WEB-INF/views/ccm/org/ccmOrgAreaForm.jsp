...
<head>
    ...
    <script type="text/javascript">
        ...
        function getPeopleNum() {
            $.ajax({
                url: ctx + "/org/ccmOrgArea/getPeopleNum?id=${ccmOrgArea.id}",
                type: "get",
        ...
        function getkeyPeopleNum() {
            $.ajax({
                url: ctx + "/org/ccmOrgArea/getkeyPeopleNum?id=${ccmOrgArea.id}",
                type: "get",
                success: function (data) {
                    $("#keyPersonnelNum").val(data)
...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a class="nav-head"
                              href="${ctx}/org/ccmOrgArea/form?id=${ccmOrgArea.id}">数据<shiro:hasPermission
                name="org:ccmOrgArea:edit">${not empty ccmOrgArea.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="org:ccmOrgArea:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <form:form id="inputForm" modelAttribute="ccmOrgArea" action="${ctx}/org/ccmOrgArea/save" method="post"
        ...
        <table border="0px"
            ...
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>关联区域：</label>
                        <div class="controls">
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="netManName" htmlEscape="false" maxlength="50"
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            ...
                            <sys:ckfinder input="icon" type="images" uploadPath="/photo" selectMultiple="false"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="politics" class="input-xlarge required">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('sys_ccm_poli_stat')}" itemLabel="label"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <form:select path="education" class="input-xlarge required">
                                <form:option value="" label=""/>
                                <form:options items="${fns:getDictList('sys_ccm_degree')}" itemLabel="label"
                                              itemValue="value" htmlEscape="false"/>
                            </form:select>
                        </div>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="netPeoNum" htmlEscape="false" maxlength="6"
            ...
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>户数：</label>
                        <div class="controls">
                            <form:input path="netNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>人口数量：</label>
                        <div class="controls">
                            <form:input path="mannum" htmlEscape="false" maxlength="10"
                                        class="input-xlarge  digits required" type="number"/>
                                <%--<button onclick="getPeopleNum()">数量汇总</button>--%>
                            <a onclick="getPeopleNum()"><span style="color: #fff">数量汇总</span></a>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="keyPersonnelNum" htmlEscape="false" maxlength="10"
                                        class="input-xlarge  digits required" type="number"/>
							<a onclick="getkeyPeopleNum()"><span style="color: #fff">数量汇总</span></a>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="videoSafetyNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="definitionNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="videoTownsNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="videoAlldayNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>党员人数：</label>
                        <div class="controls">
                            <form:input path="partyMembersNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="eachKiloNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="eachHundNum" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>扶贫主任：</label>
                        <div class="controls">
                            <form:input path="directorPovertyAlleviation" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="politicalLegalDeployment" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="firstSecretary" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="peopleLivelihoodSupervisor" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>警务助理：</label>
                        <div class="controls">
                            <form:input path="policeAssistant" htmlEscape="false" maxlength="6"
                                        class="input-xlarge  digits required" type="number"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="areaMap" readonly="true" htmlEscape="false" maxlength="20000"
                                        class="input-xlarge "/>
                        </div>
                    </div>
                </td>
        ...
        <div class="form-actions">
            <shiro:hasPermission name="org:ccmOrgArea:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"

...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="org:ccmOrgNpseSecurity:edit">
		    <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseSecurity/form', '添加', '1100px', '720px')"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
		...
		<c:forEach items="${page.list}" var="ccmOrgNpse">
			<tr>
				...
				<td>
					<a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseSecurity/form?id=${ccmOrgNpse.id}', '详情', '1100px', '800px')">${ccmOrgNpse.compName}</a>
...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td>
					<shiro:hasPermission name="org:ccmOrgNpseSecurity:edit">
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseSecurity/form?id=${ccmOrgNpse.id}', '编辑', '1100px', '800px')" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/org/ccmOrgNpseSecurity/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该治安重点吗？', this.href)"  title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					</shiro:hasPermission>

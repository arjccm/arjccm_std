...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td>
					<shiro:hasPermission name="org:ccmOrgNpsesafe:edit">
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpsesafe/form?id=${ccmOrgNpse.id}', '编辑', '1100px', '800px')"title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/org/ccmOrgNpsesafe/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该安全生产重点吗？', this.href)"  title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					</shiro:hasPermission>

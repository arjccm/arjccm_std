...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td>
					<shiro:hasPermission name="org:ccmOrgNpsesafe:edit">
						...
						<a class="btnList" href="${ctx}/org/ccmOrgNpsesafe/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该安全生产重点吗？', this.href)"  title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>
					</shiro:hasPermission>

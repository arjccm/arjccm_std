...
<body>
	<ul class="nav nav-tabs">
		<li><a style="width: 140px;text-align:center" href="${ctx}/org/ccmOrgInfovideo/">数据列表</a></li>
		<li class="active" style="width: 140px"><a class="nav-head" href="${ctx}/org/ccmOrgInfovideo/form?id=${ccmOrgInfovideo.id}">数据<shiro:hasPermission name="org:ccmOrgInfovideo:edit">${not empty ccmOrgInfovideo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="org:ccmOrgInfovideo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ccmOrgInfovideo" action="${ctx}/org/ccmOrgInfovideo/save" method="post" class="form-horizontal">
		...
		<table border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; padding: 10px; width: 100%" >
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>中心名称：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>中心联系方式：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>中心层级：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>中心负责人姓名：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>专职工作人员数量：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>年度运行经费（元）：</label>
						<div class="controls">
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>联网公共安全视频监控摄像机数量：</label>
						<div class="controls">
			...
			<tr>
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red">*</font> </span>是否24小时有人值守：</label>
						<div class="controls">

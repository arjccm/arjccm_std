...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td>
					<shiro:hasPermission name="org:ccmOrgNpseFire:edit">
						...
						<a class="btnList" href="${ctx}/org/ccmOrgNpseFire/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该消防安全重点吗？', this.href)"  title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>
					</shiro:hasPermission>

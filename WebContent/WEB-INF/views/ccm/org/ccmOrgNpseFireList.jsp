...
<ul class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpseFire/">数据列表</a></li>
...
<%--			<li class="clearfix"></li>--%>
	...
	<div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="org:ccmOrgNpseFire:edit">
            <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseFire/form', '添加', '1100px', '720px')"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
		...
		<c:forEach items="${page.list}" var="ccmOrgNpse">
			<tr>
				...
				<td>
					<a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseFire/form?id=${ccmOrgNpse.id}', '详情', '1100px', '800px')">${ccmOrgNpse.compName}</a>
...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td>
					<shiro:hasPermission name="org:ccmOrgNpseFire:edit">
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseFire/form?id=${ccmOrgNpse.id}', '编辑', '1100px', '720px')"title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/org/ccmOrgNpseFire/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该消防安全重点吗？', this.href)"  title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					</shiro:hasPermission>

...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpse/list?compType=04">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/?compType=04" method="post"
        ...
        <div class="clearfix pull-right btn-box">
            ...
            <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?compType=04', '添加', '1100px', '800px')"
                    class="btn btn-export" style="width: 49px;display:inline-block;float: right;"><i
                    class="icon-export"></i> <span style="font-size: 12px">添加</span></a>
            </shiro:hasPermission>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmOrgNpse">
            <tr>
                ...
                <td>
                    <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?id=${ccmOrgNpse.id}', '详情', '1100px', '800px')">${ccmOrgNpse.compName}</a>
                </td>
                ...
                <shiro:hasPermission name="org:ccmOrgNpse:edit">
                    <td>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?id=${ccmOrgNpse.id}', '添加', '1100px', '800px')"><i
                                class="iconfont icon-caozuotubiao-xiugai"></i></a>
                        <a class="btnList" href="${ctx}/org/ccmOrgNpse/delete?id=${ccmOrgNpse.id}"
                           onclick="return confirmx('确认要删除该非公有制经济组织吗？', this.href)" title="删除"><i

...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgGropprevent/">数据列表</a></li>
    ...
    <form:form id="searchForm" modelAttribute="ccmOrgGropprevent" action="${ctx}/org/ccmOrgGropprevent/" method="post"
    ...
    <ul class="ul-form pull-left">
        ...
        <li class="second-line"><label>学历：</label>
            <form:select path="education" class="input-medium">
                <form:option value="" label="全部"/>
                <form:options items="${fns:getDictList('sys_ccm_degree')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/>
            </form:select>
        </li>
    ...
    <div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="org:ccmOrgGropprevent:edit">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmOrgGropprevent">
            <tr>
                ...
                <td>
                    <a onclick="parent.parent.LayerDialog('${ctx}/org/ccmOrgGropprevent/form?id=${ccmOrgGropprevent.id}', '查看', '1330px', '600px')">
                ...
                <shiro:hasPermission name="org:ccmOrgGropprevent:edit">
                    <td>
                        <a class="btnList"
                           onclick="parent.parent.LayerDialog('${ctx}/org/ccmOrgGropprevent/form?id=${ccmOrgGropprevent.id}', '修改', '1330px', '600px')"
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
                        <a class="btnList" href="${ctx}/org/ccmOrgGropprevent/delete?id=${ccmOrgGropprevent.id}"
                           onclick="return confirmx('确认要删除该人员信息吗？', this.href)" title="删除"><i

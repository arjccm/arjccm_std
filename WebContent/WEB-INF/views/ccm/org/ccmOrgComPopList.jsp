...
<%--				</td>--%>
				...
				<shiro:hasPermission name="org:ccmOrgComPop:edit"><td style="height: 50px">
					...
					<a class="btnList" href="${ctx}/org/ccmOrgComPop/delete?id=${ccmOrgComPop.id}" onclick="return confirmx('确认要删除该公共机构人员吗？', this.href)"  title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

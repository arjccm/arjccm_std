...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgComPop/">数据列表</a></li>
		<shiro:hasPermission name="org:ccmOrgComPop:edit"><li><a style="text-align:center" href="${ctx}/org/ccmOrgComPop/form">数据添加</a></li></shiro:hasPermission>
	</ul>

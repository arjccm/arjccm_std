...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpse/list?compType=02">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/?compType=02" method="post"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="org:ccmOrgNpse:edit">
                <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?compType=02', '添加', '1100px', '800px')"

...
<%--					${ccmOrgNpse.compName}</a>--%>
				...
				<td>
					<shiro:hasPermission name="org:ccmOrgNpseLog:edit">
						<a class="btnList" onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseLog/form?id=${ccmOrgNpse.id}', '编辑', '1100px', '800px')"title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a class="btnList" href="${ctx}/org/ccmOrgNpseLog/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该物流安全重点吗？', this.href)"  title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					</shiro:hasPermission>

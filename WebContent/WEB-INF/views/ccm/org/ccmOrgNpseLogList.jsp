...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpseLog/">数据列表</a></li>
        <%-- <shiro:hasPermission name="org:ccmOrgNpseLog:edit"><li><a href="${ctx}/org/ccmOrgNpseLog/form">物流安全重点添加</a></li></shiro:hasPermission> --%>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpseLog/" method="post"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="org:ccmOrgNpseLog:edit">
                <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseLog/form', '添加', '1100px', '800px')"
                   class="btn btn-export" style="width: 49px;display:inline-block;float: right;"><i></i> <span
                        style="font-size: 12px">添加</span></a></li>
            </shiro:hasPermission>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmOrgNpse">
            <tr>
                ...
                <td>
                    <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseLog/form?id=${ccmOrgNpse.id}', '详情', '1100px', '800px')">${ccmOrgNpse.compName}</a>
                ...
                <td>
                    <shiro:hasPermission name="org:ccmOrgNpseLog:edit">
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseLog/form?id=${ccmOrgNpse.id}', '编辑', '1100px', '800px')"
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
                        <a class="btnList" href="${ctx}/org/ccmOrgNpseLog/delete?id=${ccmOrgNpse.id}"
                           onclick="return confirmx('确认要删除该物流安全重点吗？', this.href)" title="删除"><i

...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpse/list?compType=03">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/?compType=03" method="post"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="org:ccmOrgNpse:edit">
                <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?compType=03', '添加', '1100px', '800px')"
        ...
        <c:forEach items="${page.list}" var="ccmOrgNpse">
            <tr>
                ...
                <shiro:hasPermission name="org:ccmOrgNpse:edit">
                    <td>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?id=${ccmOrgNpse.id}', '编辑', '1100px', '800px')"><i

...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <shiro:hasPermission name="org:ccmOrgLeadduty:edit">
            <li><a href="${ctx}/org/ccmOrgLeadduty/form">数据添加</a></li>
        </shiro:hasPermission>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgLeadduty" action="${ctx}/org/ccmOrgLeadduty/" method="post"
        ...
        <ul class="ul-form">
            ...
            <li><label>政策种类：</label>
                <form:select path="policyType" class="input-medium">
                    ...
                    <form:options items="${fns:getDictList('ccm_pol_var')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </li>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach items="${page.list}" var="ccmOrgLeadduty">
            <tr>
                ...
                <shiro:hasPermission name="org:ccmOrgLeadduty:edit">
                    <td>
                        <a class="btnList" href="${ctx}/org/ccmOrgLeadduty/form?id=${ccmOrgLeadduty.id}" title="修改"><i
                                class="iconfont icon-caozuotubiao-xiugai"></i></a>
                        <a class="btnList" href="${ctx}/org/ccmOrgLeadduty/delete?id=${ccmOrgLeadduty.id}"
                           onclick="return confirmx('确认要删除该综治领导责任制吗？', this.href)" title="删除"><i

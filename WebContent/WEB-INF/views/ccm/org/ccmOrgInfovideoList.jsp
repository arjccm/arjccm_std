...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgInfovideo/">数据列表</a></li>
		<shiro:hasPermission name="org:ccmOrgInfovideo:edit"><li><a style="text-align:center" href="${ctx}/org/ccmOrgInfovideo/form">数据添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="ccmOrgInfovideo">
			<tr>
				...
				<shiro:hasPermission name="org:ccmOrgInfovideo:edit"><td>
    				<a class="btnList" href="${ctx}/org/ccmOrgInfovideo/form?id=${ccmOrgInfovideo.id}" title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
					<a class="btnList" href="${ctx}/org/ccmOrgInfovideo/delete?id=${ccmOrgInfovideo.id}" onclick="return confirmx('确认要删除该综治视联网信息中心吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>

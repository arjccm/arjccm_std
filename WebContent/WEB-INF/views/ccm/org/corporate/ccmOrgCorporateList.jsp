...
<ul class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/?compType=01" method="post"
        ...
        <ul class="ul-form pull-left">
            ...
            <li class="first-line"><label>所属网格：</label>
                <sys:treeselect id="area" name="area.id" value="${ccmOrgNpse.area.id}" labelName="area.name"
                                ...
                                title="区域" url="/tree/ccmTree/treeDataArea?type=7&areaid=" cssClass="input-small"

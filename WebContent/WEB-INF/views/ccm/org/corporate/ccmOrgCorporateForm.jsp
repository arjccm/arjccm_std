    ...
    <table border="0px"
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:input path="compArea" htmlEscape="false"
                                    class="input-xlarge number positivenumber required"/>
                    </div>
                </div>
            </td>
            <td>
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:input path="companyNum" htmlEscape="false" maxlength="6"
                                    class="input-xlarge number positivenumber digits required"/>
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font></span>法定代表人证件类型：</label>
                    <div class="controls">
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font></span>法定代表人证件号码：</label>
                    <div class="controls">
        ...
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font></span>治保负责人联系方式：</label>
                    <div class="controls">
                ...
                <div>
                    ...
                    <div class="controls">
                        <form:input path="survCameNum" htmlEscape="false" maxlength="5"
                                    class="input-xlarge number positivenumber digits"/>
                    </div>
                </div>
            </td>
        </tr>

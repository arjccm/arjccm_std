...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/report/ccmReportOthers/organization">机构组织分析</a></li>
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpse/list">机构组织列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/listAll" method="post"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="org:ccmOrgNpse:edit">
                <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/form', '添加', '1100px', '800px')"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        ...
        <c:forEach items="${page.list}" var="ccmOrgNpse">
            <tr>
                ...
                <td>
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/form?id=${ccmOrgNpse.id}', '详情', '1100px', '800px')">
                ...
                <td>
                    <shiro:hasPermission name="org:ccmOrgNpse:edit">
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/form?id=${ccmOrgNpse.id}', '编辑', '1100px', '800px')"><i
                                class="iconfont icon-caozuotubiao-xiugai"></i></a>
                        <a class="btnList" href="${ctx}/org/ccmOrgNpse/deleteData?id=${ccmOrgNpse.id}"
                           onclick="return confirmx('确认要删除该机构济组织吗？', this.href)" title="删除"><i
                                class="iconfont icon-caozuotubiao-shanchu"></i></a>
                        <shiro:hasPermission name="org:ccmOrgNpseEconomic:view">
                            <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpseEconomic/listEconomic?naspId=${ccmOrgNpse.id}', '经济运行数据', '1100px', '800px')"
                               title="经济运行数据">
                                <i class="icon-list"></i>
                            </a>
                        </shiro:hasPermission>

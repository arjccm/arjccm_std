...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpseEconomic/listEconomic?naspId=${ccmOrgNpseEconomic.naspId}">数据列表</a></li>
		<shiro:hasPermission name="org:ccmOrgNpseEconomic:edit"><li><a style="text-align:center" href="${ctx}/org/ccmOrgNpseEconomic/formEconomic?naspId=${ccmOrgNpseEconomic.naspId}">数据添加</a></li></shiro:hasPermission>
	</ul>

		...
		<c:forEach items="${page.list}" var="ccmOrgNpse">
			<tr>
				...
				<td><shiro:hasPermission name="org:ccmOrgNpse:edit">
    				<a class="btnList" onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?id=${ccmOrgNpse.id}', '添加', '1100px', '800px')"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
					<a class="btnList" href="${ctx}/org/ccmOrgNpse/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该社团组织吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
					<a class="btnList"

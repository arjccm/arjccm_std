		...
		<c:forEach items="${page.list}" var="ccmOrgNpse">
			<tr>
				...
				<td><shiro:hasPermission name="org:ccmOrgNpse:edit">
					...
					<a class="btnList" href="${ctx}/org/ccmOrgNpse/delete?id=${ccmOrgNpse.id}" onclick="return confirmx('确认要删除该社团组织吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>
					<a class="btnList"

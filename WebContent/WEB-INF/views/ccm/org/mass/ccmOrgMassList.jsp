...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/org/ccmOrgNpse/list?compType=05">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmOrgNpse" action="${ctx}/org/ccmOrgNpse/?compType=05" method="post"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="org:ccmOrgNpse:edit">
                <a onclick="parent.LayerDialog('${ctx}/org/ccmOrgNpse/formData?compType=05', '添加', '1100px', '800px')"
                ...
                <shiro:hasPermission name="org:ccmOrgNpse:edit">
                    <td>
                        ...
                        <a class="btnList" href="${ctx}/org/ccmOrgNpse/delete?id=${ccmOrgNpse.id}"
                           onclick="return confirmx('确认要删除该社团组织吗？', this.href)" title="删除"><i

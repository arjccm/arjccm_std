...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/chemical/ccmPlaceChemical/">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceChemical"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="chemical:ccmPlaceChemical:edit">
                <a onclick="parent.LayerDialog('${ctx}/chemical/ccmPlaceChemical/form', '添加', '1200px', '900px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceChemical">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/chemical/ccmPlaceChemical/form?id=${ccmPlaceChemical.id}', '详情', '1200px', '900px')">${ccmPlaceChemical.placeName}</a>
                </td>
                ...
                <shiro:hasPermission name="chemical:ccmPlaceChemical:edit">
                    <td>
                        ...
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/toaddPeople?placeOrgId=${ccmPlaceChemical.ccmBasePlace.id}&type=1', '从业人员添加', '1550px', '800px')"
                           title="从业人员添加"><i class="iconfont icon-congyerenyuantianjia"></i></a>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceChemical.ccmBasePlace.id}&type=1', '从业人员信息', '1550px', '800px')"

...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/hotel/ccmPlaceHotel/01">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceHotel"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="hotel:ccmPlaceHotel:edit">
                <a onclick="parent.LayerDialog('${ctx}/hotel/ccmPlaceHotel/form?type=01', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceHotel">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/hotel/ccmPlaceHotel/form?id=${ccmPlaceHotel.id}', '详情', '1100px', '700px')">${ccmPlaceHotel.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该酒店住宿吗？', this.href)"
                                                                                               title="删除"><i
                            class="iconfont icon-caozuotubiao-shanchu"></i></a>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/toaddPeople?placeOrgId=${ccmPlaceHotel.ccmBasePlace.id}&type=1', '从业人员添加', '1550px', '800px')"
                           title="从业人员添加"><i class="iconfont icon-congyerenyuantianjia"></i></a>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceHotel.ccmBasePlace.id}&type=1', '从业人员信息', '1550px', '800px')"

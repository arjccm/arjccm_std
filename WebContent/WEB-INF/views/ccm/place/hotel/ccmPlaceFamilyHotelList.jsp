...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/hotel/ccmPlaceHotel/02">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceHotel"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="hotel:ccmPlaceHotel:edit">
                <a onclick="parent.LayerDialog('${ctx}/hotel/ccmPlaceHotel/form?type=02', '添加', '1100px', '700px')"

...
<form:form id="inputForm" modelAttribute="ccmPlaceCasino"
    ...
    <table>
        <tr>
            <td style="width: 50%;"><label class="control-label"><span class="help-inline"><font
                    color="red">*</font></span>场所名称：</label>
                <div class="controls">
    ...
    <table>
        <tr>
            <td><label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>是否安装了监控设备：</label>
                <div class="controls">
            ...
            <td><label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>安全通道是否畅通：</label>
                <div class="controls">
        ...
        <tr>
            <td><label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>是否有灭火器材：</label>
                <div class="controls">
            ...
            <td><label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>是否有疏散指示标志：</label>
                <div class="controls">
        ...
        <tr>
            <td><label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>是否有应急照明灯：</label>
                <div class="controls">
            ...
            <td><label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>是否有经营许可证：</label>
                <div class="controls">

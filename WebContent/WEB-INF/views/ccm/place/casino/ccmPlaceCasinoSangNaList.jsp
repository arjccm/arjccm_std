...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/casino/ccmPlaceCasino/07">数据列表</a></li>
    </ul>
    ...
    <form:form id="searchForm" modelAttribute="ccmPlaceCasino"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="casino:ccmPlaceCasino:edit">
                <a onclick="parent.LayerDialog('${ctx}/casino/ccmPlaceCasino/form?type=07', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceCasino">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/casino/ccmPlaceCasino/form?type=07&id=${ccmPlaceCasino.id}', '详情', '1100px', '700px')">${ccmPlaceCasino.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该桑拿场所吗？', this.href)"
                                                                                               title="删除"><i

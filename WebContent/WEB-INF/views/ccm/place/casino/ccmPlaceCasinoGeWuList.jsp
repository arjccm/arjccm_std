...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/casino/ccmPlaceCasino/03">数据列表</a></li>
    </ul>
    ...
    <div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="casino:ccmPlaceCasino:edit">
            <a onclick="parent.LayerDialog('${ctx}/casino/ccmPlaceCasino/form?type=03', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceCasino">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/casino/ccmPlaceCasino/form?type=03&id=${ccmPlaceCasino.id}', '详情', '1100px', '700px')">${ccmPlaceCasino.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该歌舞厅场所吗？', this.href)"
                                                                                               title="删除"><i

...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/casino/ccmPlaceCasino/08">数据列表</a></li>
    </ul>
    ...
    <form:form id="searchForm" modelAttribute="ccmPlaceCasino"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="casino:ccmPlaceCasino:edit">
                <a onclick="parent.LayerDialog('${ctx}/casino/ccmPlaceCasino/form?type=08', '添加', '1100px', '700px')"
            ...
            <a href="javascript:;" id="btnSubmit"
               class="btn btn-primary" style="width: 49px;display:inline-block;float: right;> <i></i> <span style="
               font-size: 12px">查询</span>
            </a>
        </div>
    </form:form>
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceCasino">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/casino/ccmPlaceCasino/form?type=08&id=${ccmPlaceCasino.id}', '详情', '1100px', '700px')">${ccmPlaceCasino.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该沐足场所吗？', this.href)"
                                                                                               title="删除"><i
                            class="iconfont icon-caozuotubiao-shanchu"></i></a>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/toaddPeople?placeOrgId=${ccmPlaceCasino.ccmBasePlace.id}&type=1', '从业人员添加', '1550px', '800px')"
                           title="从业人员添加"><i class="iconfont icon-caozuotubiao-shejiaoguanxi"></i></a>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceCasino.ccmBasePlace.id}&type=1', '从业人员信息', '1550px', '800px')"

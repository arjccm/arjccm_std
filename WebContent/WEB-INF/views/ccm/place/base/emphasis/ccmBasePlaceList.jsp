			...
			<c:forEach items="${page.list}" var="ccmBasePlace">
				<tr>
					...
					<shiro:hasPermission name="place:ccmBasePlace:edit">
						...
						<a class="btnList" href="${ctx}/place/ccmBasePlace/emphasisDelete?id=${ccmBasePlace.id}" onclick="return confirmx('确认要删除该场所信息吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

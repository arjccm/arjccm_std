...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/education/ccmPlaceEducation/03">数据列表</a></li>
    </ul>
    ...
    <div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="education:ccmPlaceEducation:edit">
            <a onclick="parent.LayerDialog('${ctx}/education/ccmPlaceEducation/form?type=03', '添加', '1100px', '700px')"

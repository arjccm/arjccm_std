...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/education/ccmPlaceEducation/02">数据列表</a></li>
    </ul>
    ...
    <div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="education:ccmPlaceEducation:edit">
            <a onclick="parent.LayerDialog('${ctx}/education/ccmPlaceEducation/form?type=02', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceEducation">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/education/ccmPlaceEducation/form?id=${ccmPlaceEducation.id}', '详情', '1100px', '700px')">${ccmPlaceEducation.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该研究院吗？', this.href)"
                                                                                               title="删除"><i

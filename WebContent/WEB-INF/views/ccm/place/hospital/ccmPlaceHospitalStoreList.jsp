...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/hospital/ccmPlaceHospital/03">数据列表</a></li>
    ...
    <div class="clearfix pull-right btn-box">
        <shiro:hasPermission name="hospital:ccmPlaceHospital:edit">
            <a onclick="parent.LayerDialog('${ctx}/hospital/ccmPlaceHospital/form?type=03', '添加', '1100px', '700px')"

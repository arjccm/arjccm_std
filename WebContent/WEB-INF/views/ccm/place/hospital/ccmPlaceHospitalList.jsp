...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/hospital/ccmPlaceHospital/01">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceHospital"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="hospital:ccmPlaceHospital:edit">
                <a onclick="parent.LayerDialog('${ctx}/hospital/ccmPlaceHospital/form?type=01', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceHospital">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/hospital/ccmPlaceHospital/form?id=${ccmPlaceHospital.id}', '详情', '1100px', '700px')">${ccmPlaceHospital.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该医疗卫生场所吗？', this.href)"
                                                                                               title="删除"><i

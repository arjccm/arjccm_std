...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/financial/ccmPlaceFinancial/">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceFinancial"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="financial:ccmPlaceFinancial:edit">
                <a onclick="parent.LayerDialog('${ctx}/financial/ccmPlaceFinancial/form', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceFinancial">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/financial/ccmPlaceFinancial/form?id=${ccmPlaceFinancial.id}', '详情', '1100px', '700px')">
                ...
                <shiro:hasPermission name="financial:ccmPlaceFinancial:edit">
                    <td>
                        ...
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/toaddPeople?placeOrgId=${ccmPlaceFinancial.ccmBasePlace.id}&type=1', '从业人员添加', '1550px', '800px')"
                           title="从业人员添加"><i class="iconfont icon-congyerenyuantianjia"></i></a>
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceFinancial.ccmBasePlace.id}&type=1', '从业人员信息', '1550px', '800px')"

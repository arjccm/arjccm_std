				...
				<tr>
					...
					<shiro:hasPermission name="financial:ccmPlaceFinancial:edit">
						<td>
							...
							<a class="btnList"
							   onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/toaddPeople?placeOrgId=${ccmPlaceFinancial.ccmPlaceLive.ccmBasePlace.id}&type=1', '从业人员添加', '1550px', '800px')"
							   title="从业人员添加"><i class="icon-group"></i></a>
							<a class="btnList"
							   onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceFinancial.ccmPlaceLive.ccmBasePlace.id}&type=1', '从业人员信息', '1550px', '800px')"

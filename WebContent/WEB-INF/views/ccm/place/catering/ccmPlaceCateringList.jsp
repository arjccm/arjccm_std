...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/catering/ccmPlaceCatering/01">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceCatering"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="catering:ccmPlaceCatering:edit">
                <a onclick="parent.LayerDialog('${ctx}/catering/ccmPlaceCatering/form?type=01', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceCatering">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/catering/ccmPlaceCatering/form?id=${ccmPlaceCatering.id}', '详情', '1100px', '700px')">${ccmPlaceCatering.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该餐饮场所吗？', this.href)"
                                                                                               title="删除"><i
                        ...
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/placeorgpeople/ccmPlaceOrgPeople/list?placeOrgId=${ccmPlaceCatering.ccmBasePlace.id}&type=1', '从业人员信息', '1550px', '800px')"

...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/live/ccmPlaceLive/1">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceLive"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="live:ccmPlaceLive:edit">
                <a onclick="parent.LayerDialog('${ctx}/live/ccmPlaceLive/form', '添加', '1100px', '700px')"
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceLive">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/live/ccmPlaceLive/form?id=${ccmPlaceLive.id}', '详情', '1100px', '700px')">

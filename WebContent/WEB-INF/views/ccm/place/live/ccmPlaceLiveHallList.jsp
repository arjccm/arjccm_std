...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/live/ccmPlaceLive/3">数据列表</a></li>
    </ul>
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceLive">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/live/ccmPlaceLive/form?type=3&id=${ccmPlaceLive.id}', '详情', '1100px', '700px')">

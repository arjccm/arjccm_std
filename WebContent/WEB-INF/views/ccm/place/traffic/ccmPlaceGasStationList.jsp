...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/traffic/ccmPlaceTraffic/03">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceTraffic"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="traffic:ccmPlaceTraffic:edit">
                <a onclick="parent.LayerDialog('${ctx}/traffic/ccmPlaceTraffic/form?type=03', '添加', '1100px', '700px')"
                   class="btn btn-export" style="width: 49px;display:inline-block;float: right;"><i></i><span>添加</span>
                </a>
            </shiro:hasPermission>
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="ccmPlaceTraffic">
            <tr>
                ...
                <td><a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/traffic/ccmPlaceTraffic/form?id=${ccmPlaceTraffic.id}', '详情', '1100px', '700px')">${ccmPlaceTraffic.placeName}</a>
                </td>
                    ...
                    <td>
                        ...
                        <a class="btnList"
                           ...
                           title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a> <a class="btnList"
                                                                                               ...
                                                                                               onclick="return confirmx('确认要删除该停车场吗？', this.href)"
                                                                                               title="删除"><i

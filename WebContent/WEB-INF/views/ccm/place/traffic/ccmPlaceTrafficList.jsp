...
<ul class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/traffic/ccmPlaceTraffic/01">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPlaceTraffic"
        ...
        <div class="clearfix pull-right btn-box">
            <shiro:hasPermission name="traffic:ccmPlaceTraffic:edit">
                <a onclick="parent.LayerDialog('${ctx}/traffic/ccmPlaceTraffic/form?type=01', '添加', '1100px', '700px')"

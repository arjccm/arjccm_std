...
<div class="back-list clearfix">
    ...
    <ul class="nav nav-tabs">
        <shiro:hasPermission name="report:ccmPeopleStat:view">
            <li><a style="text-align:center"
                   href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatBehind">数据统计</a></li>
        </shiro:hasPermission>
    ...
    <div class="clearfix pull-right btn-box">
        ...
        <shiro:hasPermission name="pop:ccmPopBehind:import">
        ...
        <shiro:hasPermission name="pop:ccmPopBehind:export">
            ...
            <tr>
                ...
                <td class="tc"><shiro:hasPermission name="pop:ccmPopBehind:edit">
                    ...
                    <a class="btnList"
                       ...
                       onclick="return confirmx('确认要删除该留守人员吗？', this.href)" title="删除"><i
                            class="iconfont icon-caozuotubiao-shanchu"></i></a>
                    <a class="btnList"
                       href="javascript:;" onclick="LocationOpen('${ccmPopBehind.peopleId}')" title="位置信息"><i
                            class="iconfont icon-caozuotubiao-weizhixinxi "></i></a>
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmPopBehind.peopleId}', '社交关系', '1000px', '700px')"
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/list?relevance_id=${ccmPopBehind.id}&relevance_table=ccm_pop_behind', '记录信息', '800px', '660px')"
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formPro?relevance_id=${ccmPopBehind.id}&relevance_table=ccm_pop_behind', '添加记录', '800px', '660px')"

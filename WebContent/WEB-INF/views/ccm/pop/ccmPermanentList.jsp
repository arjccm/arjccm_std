...
<div class="back-list clearfix">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/pop/ccmPermanent/">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmPermanent/" method="post"
    ...
    <ul class="ul-form pull-left">
        ...
        <li class="selectHidden hide"><label>出生结束时间</label> <input name="endBirthday" type="text"
                                                                                        readonly="readonly"
                                                                                        maxlength="20"
    ...
    <div class="clearfix pull-right btn-box">
        ...
        <shiro:hasPermission name="pop:ccmPermanent:export">
        ...
        <c:forEach items="${page.list}" var="ccmPeople">
            <tr>
                ...
                <td class="tc"><shiro:hasPermission name="pop:ccmPermanent:edit">
                    <a class="btnList" href="${ctx}/pop/ccmPermanent/form?id=${ccmPeople.id}" title="修改"><i
                            class="iconfont icon-caozuotubiao-xiugai"></i></a>
                    <a class="btnList" href="${ctx}/pop/ccmPermanent/delete?id=${ccmPeople.id}"

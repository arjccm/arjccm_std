...
<div class="back-list clearfix">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/pop/ccmWork/">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmWork/list/10" method="post"
        ...
        <c:forEach items="${page.list}" var="ccmPeople">
            <tr>
                ...
                <td><%--<a href="${ctx}/pop/ccmWork/form/residence?id=${ccmPeople.id}">
                        ${ccmPeople.name}</a>--%>
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmWork/form/residence?id=${ccmPeople.id}', '详情', '1500px', '700px')"
                       > ${ccmPeople.name}</a>
                </td>
                <td>
                ...
                <td><shiro:hasPermission name="pop:ccmPermanent:edit">
                    <%--<a class="btnList"  href="${ctx}/pop/ccmWork/form/residence?id=${ccmPeople.id}"  title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>--%>

                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmWork/form/residence?id=${ccmPeople.id}', '编辑', '1500px', '700px')"
                       title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>

                    <a class="btnList" href="${ctx}/pop/ccmWork/delete/residence?id=${ccmPeople.id}"

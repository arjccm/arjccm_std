...
<div class="context" content="${ctx}"></div>
 <!-- 导入、导出模块 -->
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="report:ccmPeopleStat:view"><li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatCare">数据统计</a></li></shiro:hasPermission>
		...
		<c:forEach items="${page.list}" var="ccmPeople">
			<tr>
				...
				<td class="tc"><shiro:hasPermission name="pop:ccmCare:edit">
					...
					<a class="btnList" href="${ctx}/pop/ccmPeople/deleteCare?id=${ccmPeople.id}" onclick="return confirmx('确认要删除该实有人口吗？', this.href)"  title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
			    	<a class="btnList"

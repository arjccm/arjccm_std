...
<div class="back-list clearfix">
    ...
    <ul class="nav nav-tabs">
        <shiro:hasPermission name="report:ccmPeopleStat:view">
            <li><a style="text-align:center" href="${ctx}/report/ccmPeopleStat/statisticsPage?title=ccmPeopleStatCare">数据统计</a>
            </li>
        </shiro:hasPermission>
        <li class="active"><a class="nav-head" href="${ctx}/pop/ccmPeople/listCareFirst">数据列表</a></li>
    </ul>
    <form:form id="searchForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmPeople/listCare" method="post"
    ...
    <ul class="ul-form pull-left">
        ...
        <li class="second-line"><label>特殊关怀类型：</label>
            <form:checkboxes path="specialCareTypeList" items="${fns:getDictList('pop_special_care_type')}"
                             itemLabel="label" itemValue="value" htmlEscape="false"/>
        </li>
    </ul>
        ...
        <c:forEach items="${page.list}" var="ccmPeople">
            <tr>
                ...
                <td class="tc"><shiro:hasPermission name="pop:ccmCare:edit">
                    ...
                    <a class="btnList" href="${ctx}/pop/ccmPeople/deleteCare?id=${ccmPeople.id}"
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/getSocialConnections?id=${ccmPeople.id}', '社交关系', '1000px', '700px')"
                    ...
                    <shiro:hasPermission name="log:ccmLogTail:edit">
                        ...
                        <a class="btnList"
                           onclick="parent.LayerDialog('${ctx}/log/ccmLogTail/formProCare?relevance_id=${ccmPeople.id}&relevance_table=ccm_people', '添加记录', '800px', '660px')"

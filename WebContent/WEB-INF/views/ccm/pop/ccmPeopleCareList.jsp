		...
		<c:forEach items="${page.list}" var="ccmPeople">
			<tr>
				...
				<td class="tc"><shiro:hasPermission name="pop:ccmPeople:edit">
					...
					<a class="btnList" href="${ctx}/pop/ccmPeople/deleteCare?id=${ccmPeople.id}" onclick="return confirmx('确认要删除该实有人口吗？', this.href)"  title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>
			    	<a class="btnList"

...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a
                href="${ctx}/pop/ccmPeopleAntiepidemic/form?id=${ccmPeopleAntiepidemic.id}">人员疫情<shiro:hasPermission
                name="pop:ccmPeopleAntiepidemic:edit">${not empty ccmPeopleAntiepidemic.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="pop:ccmPeopleAntiepidemic:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <input id="getdomicile" type="hidden" value="${ccmPeopleAntiepidemic.domicile}"/>
    <form:form id="inputForm" modelAttribute="ccmPeopleAntiepidemic" action="${ctx}/pop/ccmPeopleAntiepidemic/save"
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="comeHainanDate" type="text" readonly="readonly" maxlength="20"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="habitation" htmlEscape="false" maxlength="128" class="input-xlarge "
                                        placeholder="详情到区、社区、小区、楼栋、单元、房号"/>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="transportation" htmlEscape="false" maxlength="128" class="input-xlarge "
                                        placeholder="请输入详细的航班号、车次、车牌号等信息"/>
                        </div>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="leftDate" type="text" readonly="readonly" maxlength="20"
                                   class="input-medium Wdate "
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:textarea path="info" htmlEscape="false" rows="4" maxlength="255"
                                           class="input-xxlarge " placeholder="如xx年xx月xx日登门测量体温“正常”或送口罩或宣传防疫知识。"/>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="reportDepartment" htmlEscape="false" maxlength="64"
                                        class="input-xlarge "/>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="reportDate" type="text" readonly="readonly" maxlength="20"
                                   class="input-medium Wdate "
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="belongPoliceStation" htmlEscape="false" maxlength="32"
                                        class="input-xlarge "/>
                        </div>
                    </div>
                </td>
        ...
        <div class="form-actions">
            <shiro:hasPermission name="pop:ccmPeopleAntiepidemic:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                              type="submit"

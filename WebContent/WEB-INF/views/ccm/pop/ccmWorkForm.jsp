...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li><a style="text-align:center" href="${ctx}/pop/ccmWork">数据列表</a></li>
    ...
    <form:form id="inputForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmWork/save" method="post"
                    ...
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="accountidentity" htmlEscape="false" maxlength="18"
                                        class="input-xlarge ident1 card"/>
                            <span id="ident1"></span>
                        </div>
                    </div>
                </td>

        ...
        <table id="typeid" border="0px"
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="domicile" id="domicile" htmlEscape="false" maxlength="6"
                                        class="input-xlarge required"/>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font></span>所属房屋：</label>
        ...
        <c:if test="${not empty ccmPeople.id}">
            <shiro:hasPermission name="pop:ccmPeople:edit">
                ...
                <ul class="nav nav-pills ulz">
                    ...
                    <li>
                        <a class="gzul"
                           onclick="parent.LayerDialog('${ctx}/house/ccmHouseKym/specialform?id=${ccmPeople.id}', '重点青少年标记', '1200px', '700px')">重点青少年标记</a>
                    </li>
                    </c:if>
        ...
        <table id="person" border="0px"
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font
                                color="red">*</font> </span>户主公民身份号码：</label>
                        <div class="controls">
                            <form:input path="accountidentity" onmouseout="isHead()" id="houseCard" htmlEscape="false"
            ...
            <tr>
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="accountname" id="accountname" htmlEscape="false" maxlength="10"
                                        class="input-xlarge required"/>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    <div>
                        ...
                        <div class="controls">
                            <form:input path="accounttelephone" id="accounttelephone" htmlEscape="false"

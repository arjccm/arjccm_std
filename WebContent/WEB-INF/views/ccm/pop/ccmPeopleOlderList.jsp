...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmPeople/listOlder" method="post"
    ...
    <ul class="ul-form pull-left">
        ...
        <li class="first-line"><label>所属社区：</label>
            <sys:treeselect id="areaComId" name="areaComId.id" value="${ccmPeople.areaComId.id}"
                            ...
                            title="社区" url="/tree/ccmTree/treeDataArea?type=6" cssClass="input-small" allowClear="true"
        ...
        <c:forEach items="${page.list}" var="ccmPeople">
            <tr>
                ...
                <td class="tc"><%--<a href="${ctx}/pop/ccmPeople/formOlder?id=${ccmPeople.id}">
                    ...
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/formOlder?id=${ccmPeople.id}', '详情', '1500px', '700px')"
                       >${ccmPeople.name}</a>
                </td>
                <td class="tc">
                ...
                <td class="tc"><shiro:hasPermission name="pop:ccmOlder:edit">
                    ...
                    <a class="btnList" href="${ctx}/pop/ccmPeople/deleteOlder?id=${ccmPeople.id}"

...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a class="nav-head" href="${ctx}/pop/ccmWork/form?id=${ccmPeople.id}">数据<shiro:hasPermission
                name="pop:ccmWork:edit">${not empty ccmPeople.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="pop:ccmWork:edit">查看</shiro:lacksPermission></a></li>
    ...
    <form:form id="inputForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmWork/save/residence" method="post"
        ...
        <table border="0px"
            ...
            <tr>
                ...
                <td>
                    <div>
                        <label class="control-label"><span class="help-inline"><font color="red"
                                                                                     id="showGrid">*</font></span>所属网格：</label>
                        <div class="controls">

...
<div class="back-list clearfix">
    ...
    <form:form id="searchForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmWork/list/20" method="post"
        ...
        <c:forEach items="${page.list}" var="ccmPeople">
            <tr>
                ...
                <td><%--<a href="${ctx}/pop/ccmWork/form/flow?id=${ccmPeople.id}">
                        ${ccmPeople.name}</a>--%>
                    <a class="btnList"
                       onclick="parent.LayerDialog('${ctx}/pop/ccmWork/form/flow?id=${ccmPeople.id}', '详情', '1500px', '700px')"
                       >${ccmPeople.name}</a>
                ...
                <td><shiro:hasPermission name="pop:ccmPermanent:edit">
                    <%--<a class="btnList"  href="${ctx}/pop/ccmWork/form/flow?id=${ccmPeople.id}"  title="修改"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>--%>
                    ...
                    <a class="btnList" href="${ctx}/pop/ccmWork/delete/flow?id=${ccmPeople.id}"

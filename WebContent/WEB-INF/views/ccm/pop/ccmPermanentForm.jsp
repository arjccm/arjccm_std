...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a class="nav-head"
                              href="${ctx}/pop/ccmPermanent/form?id=${ccmPeople.id}">数据<shiro:hasPermission
    ...
    <form:form id="inputForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmPermanent/save" method="post"
    ...
    <table border="0px"
        ...
        <tr>
            ...
            <td>
                <div>
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>出生日期：</label>
                    <div class="controls">
...
<tr>
    ...
    <td>
        <div>
            <label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>婚姻状况：</label>
            <div class="controls">
    ...
    <td>
        <div>
            <label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>政治面貌：</label>
            <div class="controls">
...
<tr>
    ...
    <td>
        <div>
            <label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>是否常住：</label>
            <div class="controls">
    ...
    <td>
        <div>
            <label class="control-label"><span class="help-inline"><font
                    color="red">*</font></span>是否重点关注人员：</label>
            <div class="controls">
...
<tr>
    <td>
        <div>
            <label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>户籍门（楼）详址：</label>
            <div class="controls">
...
<tr>
    <td>
        <div>
            <label class="control-label"><span class="help-inline"><font
                    color="red">*</font> </span>现住门（楼）详址：</label>
            <div class="controls">
...
<shiro:hasPermission name="pop:ccmPeople:edit">
    <ul class="nav nav-pills ulz" style="display:none;">
        ...
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/specialform?id=${ccmPeople.id}', '吸食毒品人员标记', '1200px', '900px')">吸食毒品人员标记</a>
        </li>
        </c:if> <c:if test="${ccmPeople.isVisit==1}">
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/house/ccmHousePetition/specialform?id=${ccmPeople.id}', '非正常上访人员标记', '1200px', '900px')">非正常上访人员标记</a>
        </li>
    </c:if> <c:if test="${ccmPeople.isPsychogeny==1}">
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/house/ccmHousePsychogeny/specialform?id=${ccmPeople.id}', '易肇事肇祸精神病人标记', '1200px', '900px')">肇事肇祸精神病人标记</a>
        </li>
    </c:if>
        <c:if test="${ccmPeople.isCriminalOffense==1}">
            <li><a class="znul"
                   onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/seriousCriminalOffenseform?id=${ccmPeople.id}', '严重刑事犯罪活动嫌疑人员标记', '1200px', '900px')">严重刑事犯罪活动嫌疑人员标记</a>
            </li>
        </c:if> <c:if test="${ccmPeople.isHarmNational==1}">
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/specialHarmNationalform?id=${ccmPeople.id}', '危害国家安全活动嫌疑人员标记', '1200px', '900px')">危害国家安全活动嫌疑人员标记</a>
        </li>
    </c:if> <c:if test="${ccmPeople.isEscape==1}">
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/escapePeopleform?id=${ccmPeople.id}', '在逃人员标记', '1200px', '900px')">在逃人员标记</a>
        </li>
    </c:if> <c:if test="${ccmPeople.isDispute==1}">
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/pop/ccmPeople/specialHouseDisputeform?id=${ccmPeople.id}', '闹事行凶报复嫌疑人员标记', '1200px', '900px')">闹事行凶报复嫌疑人员标记</a>
        </li>
    </c:if> <c:if test="${ccmPeople.isDeliberatelyIllegal==1}">
        <li><a class="znul"
               onclick="parent.LayerDialog('${ctx}/house/ccmHouseDeliberatelyIllegal/specialform?id=${ccmPeople.id}', '故意违法刑释不足5年人员标记', '1200px', '900px')">故意违法刑释不足5年人员标记</a>
        </li>
    </c:if> <c:if
    ...
    <ul class="nav nav-pills ulz" style="display:none;">
        ...
        <li><a class="zzul"
               onclick="parent.LayerDialog('${ctx}/house/ccmHouseRelease/specialform?id=${ccmPeople.id}', '刑释教解人员标记', '1200px', '900px')">刑释教解人员标记</a>
        </li>
    ...
    <ul class="nav nav-pills ulz" style="display:none;">
        ...
        <li><a class="gzul"
               onclick="parent.LayerDialog('${ctx}/pop/ccmPopBehind/specialform?id=${ccmPeople.id}', '留守人员标记', '1200px', '900px')">留守人员标记</a>
        </li>
        </c:if> <c:if test="${ccmPeople.isKym==1}">
        <li><a class="gzul"
               onclick="parent.LayerDialog('${ctx}/house/ccmHouseKym/specialform?id=${ccmPeople.id}', '重点青少年标记', '1200px', '900px')">重点青少年标记</a>
        </li>
    </c:if> <c:if
...
<table id="person" border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; width: 100%">
    ...
    <tr>
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>人户一致标识：</label>
                <div class="controls">
                    <form:select path="uniformlogo" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_huh_cst')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
        ...
        <td>
            <div>
                ...
                <div class="controls">
                    <form:input path="accountidentity" htmlEscape="false" maxlength="18"
                                class="input-xlarge required ident1 card"/>
                    <span id="ident1"></span>
                </div>
            </div>
        </td>
    ...
    <tr>
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>户主姓名：</label>
                <div class="controls">
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>与户主关系：</label>
                <div class="controls">
                    <form:select path="accountrelation" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('sys_ccm_fami_ties')}" itemLabel="label"
        ...
        <td>
            <div>
                ...
                <div class="controls">
                    <form:input path="accounttelephone" htmlEscape="false" maxlength="50"
                                class="input-xlarge telephone1 phone"/>
    ...
    <tr>
            ...
            <div>
                ...
                <div class="controls">
                    <form:select path="personType" class="input-xlarge ">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_people_person_type')}" itemLabel="label"
                                      itemValue="value" htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
        ...
        <td>
            <div>
                ...
                <div class="controls">
                    <form:textarea path="personReason" htmlEscape="false" rows="3" maxlength="1000"
                                   class="input-xlarge "/>
                </div>
            </div>
        </td>
...
<table id="float" border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; width: 100%">
    ...
    <tr>
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>流入原因：</label>
                <div class="controls">
                    <form:select path="flowRea" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_flow_res')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="controls">
                    <form:select path="accrType" class="input-xlarge ">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_acc_type')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <input name="recoDate" type="text" readonly="readonly" maxlength="20"
                           class="input-medium Wdate "
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>住所类型：</label>
                <div class="controls">
                    <form:select path="domiType" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_dom_type')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
...
<table id="oversea" border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC;  width: 100%">
    ...
    <tr>
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>国籍（地区）：</label>
                <div class="controls">
    ...
    <tr>
            ...
            <div>
                ...
                <div class="controls">
                    <form:select path="idenCode" class="input-xlarge required"
                                 items="${fns:getDictList('sys_ccm_org_papers')}" itemLabel="label"
                                 itemValue="value" htmlEscape="false">
                    </form:select>
                </div>
            </div>
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>证件号码（境外）：</label>
                <div class="controls">
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>证件有效期：</label>
                <div class="controls">
                    <input name="idenDate" type="text" readonly="readonly" maxlength="20"
    ...
    <tr>
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>来华目的：</label>
                <div class="controls">
                    <form:select path="purpose" class="input-xlarge required">
                        <form:option value="" label=""/>
                        <form:options items="${fns:getDictList('ccm_cn_aim')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                </div>
            </div>
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>抵达日期：</label>
                <div class="controls">
                    <input name="arriDate" type="text" readonly="readonly" maxlength="20"
                           class="input-medium Wdate required"
        ...
        <td>
            <div>
                <label class="control-label"><span class="help-inline"><font
                        color="red">*</font> </span>预计离开日期：</label>
                <div class="controls">
                    <input name="departDate" type="text" readonly="readonly" maxlength="20"
                           class="input-medium Wdate required"
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <input name="unsettleDate" type="text" readonly="readonly" maxlength="20"
                           class="input-medium Wdate "
    ...
    <tr>
        <td>
            <div>
                ...
                <div class="controls">
                    <form:textarea path="unsettleReason" htmlEscape="false" rows="3" maxlength="255"
                                   class="input-xlarge "/>
                </div>
            </div>
        </td>

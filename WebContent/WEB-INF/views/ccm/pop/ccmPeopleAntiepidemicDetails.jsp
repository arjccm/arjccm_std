        ...
        <tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="name" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
                <!-- <font color="red" >*</font> -->
            </td>
        ...
        <tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="telephone" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="habitation" htmlEscape="false" maxlength="128" class="input-xlarge " placeholder="详情到区、社区、小区、楼栋、单元、房号" readonly="true"/>
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="cohabitant" htmlEscape="false" maxlength="128" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:select path="isLeftHainan" disabled="true" cssStyle="width: 285px">
			...
			<tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select path="health" disabled="true" cssStyle="width: 285px">
                                <form:option value="" label="" />
            ...
            <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:select path="takeSteps" disabled="true" cssStyle="width: 285px">
                                <form:option value="" label="" />
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="address" htmlEscape="false" maxlength="128" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
            </tr>
		    <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="belongPoliceStation" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="isTransferHc" htmlEscape="false" maxlength="2" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
            </tr>
		    ...
		    <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="telephoneHome" htmlEscape="false" maxlength="16" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="distributeCity" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
            </tr>
		...
		<tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="distributeNo" htmlEscape="false" maxlength="16" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="checkName" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
        </tr>
		<tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="checkTel" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
            <td>
            ...
            <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="reportName" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="reportDepartment" htmlEscape="false" maxlength="64" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:input path="reportStatus" htmlEscape="false" maxlength="2" class="input-xlarge " readonly="true"/>
                        </div>
                    </div>
                </td>
            </tr>
		...
		<tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="belongBureau" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="belongSubBureau" htmlEscape="false" maxlength="32" class="input-xlarge " readonly="true"/>
                    </div>
                </div>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <form:textarea path="info" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge " placeholder="如xx年xx月xx日登门测量体温“正常”或送口罩或宣传防疫知识。" readonly="true"/>
                        </div>
                    </div>
                </td>
                <td>

...
<body>
	...
	<form:form id="inputForm" modelAttribute="ccmPeopleAntiepidemic" action="${ctx}/pop/ccmPeopleAntiepidemic/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div id="city"> 
				<select class="prov" disabled="true"></select>  
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="isLeftHainan" disabled="true">
					<form:option value="" label="" />
					<form:options items="${fns:getDictList('is_key_place')}"
						itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="health" disabled="true">
						<form:option value="" label="" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="takeSteps" disabled="true">
						<form:option value="" label="" />

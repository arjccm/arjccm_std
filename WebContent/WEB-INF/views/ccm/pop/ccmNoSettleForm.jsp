...
<body>
	<%--<ul class="nav nav-tabs">
		<li><a style="text-align:center" href="${ctx}/pop/ccmWork/list/40">数据列表</a></li>
		<li class="active"><a class="nav-head" href="${ctx}/pop/ccmWork/form/noSettle?id=${ccmPeople.id}">数据<shiro:hasPermission name="pop:ccmWork:edit">${not empty ccmPeople.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="pop:ccmWork:edit">查看</shiro:lacksPermission></a></li>
	...
	<form:form id="inputForm" modelAttribute="ccmPeople" action="${ctx}/pop/ccmWork/save/noSettle" method="post" class="form-horizontal">
		...
		<table id="person" border="0px" style="border-color: #CCCCCC; border: 0px solid #CCCCCC; width: 100%" >
			...
			<tr>
				...
				<td>
					<div>
						<label class="control-label"><span class="help-inline"><font color="red" id="show1">*</font></span>户籍变动时间：</label>
						<div class="controls">
							<input name="personTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"

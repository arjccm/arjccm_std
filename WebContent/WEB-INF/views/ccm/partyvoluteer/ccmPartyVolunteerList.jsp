			...
			<tr>
				...
				<shiro:hasPermission name="partyvoluteer:ccmPartyVolunteer:edit"><td>
					...
					<%--<a href="${ctx}/partyvoluteer/ccmPartyVolunteer/delete?id=${ccmPartyVolunteer.id}" onclick="return confirmx('确认要删除该志愿者管理吗？', this.href)">删除</a>--%>
						<a  class="btnList"
							onclick="parent.parent.parent.LayerDialog('${ctx}/partyvoluteer/ccmPartyVolunteer/form?id=${ccmPartyVolunteer.id}', '修改', '1100px', '700px')"><i class="iconfont icon-caozuotubiao-xiugai"></i></a>
						<a  class="btnList"

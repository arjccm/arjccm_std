...
<body>
	<ul class="nav nav-tabs">
		<li><a style="text-align:center" href="${ctx}/know/ccmKnowKeyMeeting/">数据列表</a></li>
		<li class="active"><a class="nav-head" href="${ctx}/know/ccmKnowKeyMeeting/form?id=${ccmKnowKeyMeeting.id}">数据<shiro:hasPermission name="know:ccmKnowKeyMeeting:edit">${not empty ccmKnowKeyMeeting.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="know:ccmKnowKeyMeeting:edit">查看</shiro:lacksPermission></a></li>
	</ul>

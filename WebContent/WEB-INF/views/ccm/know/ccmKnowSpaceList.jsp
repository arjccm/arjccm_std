...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/know/ccmKnowSpace/">数据列表</a></li>
		<shiro:hasPermission name="know:ccmKnowSpace:edit"><li><a style="text-align:center" href="${ctx}/know/ccmKnowSpace/form">数据添加</a></li></shiro:hasPermission>
	</ul>

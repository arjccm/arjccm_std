		...
		<c:forEach items="${page.list}" var="ccmPatrolUnit">
			<tr>
				...
				<shiro:hasPermission name="patrol:ccmPatrolUnit:edit"><td>
					...
					<a href="${ctx}/patrol/ccmPatrolUnit/delete?id=${ccmPatrolUnit.id}" onclick="return confirmx('确认要删除该巡逻单位吗？', this.href)"><i style="color:red;" class="iconfont icon-icondaohangtubiao-shujucaijifenxi" title="删除"></i></a>

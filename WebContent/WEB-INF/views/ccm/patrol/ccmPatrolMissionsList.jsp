		...
		<c:forEach items="${page.list}" var="ccmPatrolMissions">
			<tr>
				...
				<shiro:hasPermission name="patrol:ccmPatrolMissions:edit"><td>
					...
					<a href="${ctx}/patrol/ccmPatrolMissions/delete?id=${ccmPatrolMissions.id}" onclick="return confirmx('确认要删除该巡逻任务吗？', this.href)"><i style="color:red;" class="iconfont icon-icondaohangtubiao-shujucaijifenxi" title="删除"></i></a>

...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/patrol/ccmPatrolPlan/form?id=${ccmPatrolPlan.id}">数据<shiro:hasPermission name="patrol:ccmPatrolPlan:edit">${not empty ccmPatrolPlan.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="patrol:ccmPatrolPlan:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm " modelAttribute="ccmPatrolPlan" 
		...
		<table width="100%">
			...
			<tr>
				<td >
					<div class="control-group">
						<label class="control-label" style="float: left">巡检内容：</label>
						<div class="controls">
			...
			<tr>
				<td colspan="3">
					<div class="control-group checkPoint" style="height: 700px"></div>

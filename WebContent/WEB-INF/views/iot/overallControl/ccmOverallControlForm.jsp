...
<%--	</ul>--%>
<form:form id="inputForm" modelAttribute="ccmPeople" cssStyle="padding: 10px;"
           action="${ctx}/overallControl/ccmOverallControl/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
            ...
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <form:input path="name" htmlEscape="false" disabled="disabled" maxlength="64"
                                    class="input-xlarge hide1 required"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <form:radiobuttons path="sex" items="${fns:getDictList('sex')}"
                                           itemLabel="label" disabled="disabled" itemValue="value" htmlEscape="false"
                                           class="input-xlarge hide1 required"/>
            ...
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <form:input path="ident" htmlEscape="false" disabled="disabled" maxlength="18"
                                    class="input-xlarge hide1 required"/>
                            <%--				<span class="help-inline"><font color="red">*</font> </span>--%>
                    </div>
                </div>
            ...
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <form:input path="age" htmlEscape="false" disabled="disabled" maxlength="3"
                                    class="input-xlarge hide1 required"/>
    ...
    <table>
        <tr>
            <td>
                <div class="control-group">
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>布控名称：</label>
                    <div class="controls">
            ...
            <td>
                <div class="control-group">
                    <label class="control-label"><span class="help-inline"><font
                            color="red">*</font> </span>布控等级：</label>
                    <div class="controls">
            ...
            <tr>
                <td colspan="2">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select data-placeholder="选择一个或多个名单库" name="librarySelect" class="chosen-select required"
                                    multiple tabindex="4">
                                <option value=""></option>
            ...
            <tr>
                <td>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select data-placeholder="选择一个或多个名单库" name="captureMachine" class="chosen-select required"
                                    multiple tabindex="4">
                                <option value=""></option>
                        ...
                        <div class="controls">
                            <ul class="nav nav-pills">
                                <c:if test="${not empty ccmPeople.telephone}">
                                    ...
                                    <li class="markli"
                                        style="background-color:#6495ED;color:#FFF;">${ccmPeople.telephone}</li>
                                </c:if>
                                <c:forEach items="${phoneList}" var="phone">
                                    <input type="hidden" name="telephone" value="${phone.textName}"/>
                                    <li class="markli"
                                        style="background-color:#6495ED;color:#FFF;">${phone.textName}</li>
                                </c:forEach>
                            </ul>
                        </div>
                    </div>
                ...
                <td colspan="2">
                    <div class="control-group">
                        ...
                        <c:if test="${ empty vehicleList}">
                            <label style="padding-top: 3px">暂无车辆信息</label>
                        </c:if>
                        <div class="controls">
                            <ul class="nav nav-pills">
                                <c:forEach items="${vehicleList}" var="vehicle">
                                    <input type="hidden" id="carNumber" name="vehicleNumber"
                                           value="${vehicle.textName}"/>
                                    <li class="markli" style="background-color:#6495ED;color:#FFF;"
                                        name="vehicleNumber">${vehicle.textName}</li>
                                </c:forEach>
                            </ul>
                        </div>
    ...
    <div class="form-actions">
        ...
        <shiro:hasPermission name="overallControl:ccmOverallControl:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                                 onclick="saveForm()" type="button"

		...
		<c:forEach items="${page.list}" var="ccmEarlyWarning">
			<tr>
				...
				<shiro:hasPermission name="warning:ccmEarlyWarning:edit"><td>
					...
					<a href="${ctx}/warning/ccmEarlyWarning/deleteImportantList?id=${ccmEarlyWarning.id}" onclick="return confirmx('确认要删除该人员记录吗？', this.href)" title="删除"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a>

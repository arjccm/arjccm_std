...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        <li class="active"><a class="nav-head" href="${ctx}/act/process/">流程管理</a></li>
        <shiro:hasPermission name="act:process:edit">
            ...
            <tr>
                ...
                <td>
                        ...
                        <c:if test="${process.suspended}">
                            <a class="btnList" href="${ctx}/act/process/update/active?procDefId=${process.id}"
                               onclick="return confirmx('确认要激活吗？', this.href)" title="激活"><i class="icon-lightbulb"></i></a>
                        </c:if>
                        <c:if test="${!process.suspended}">
                            <a class="btnList" href="${ctx}/act/process/update/suspend?procDefId=${process.id}"
                               onclick="return confirmx('确认要挂起吗？', this.href)" title="挂起"><i
                                    class="icon-pushpin"></i></a>
                        </c:if>
                        <a class="btnList" href='${ctx}/act/process/delete?deploymentId=${process.deploymentId}'
                           onclick="return confirmx('确认要删除该流程吗？', this.href)" title="删除"><i
                                class="iconfont icon-caozuotubiao-shanchu"></i></a>
                        <a class="btnList" href='${ctx}/act/process/convert/toModel?procDefId=${process.id}'
                           onclick="return confirmx('确认要转换为模型吗？', this.href)" title="转换为模型"><i

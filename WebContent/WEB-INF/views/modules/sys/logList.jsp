...
<div class="back-list clearfix">
    ...
    <ul class="ul-form">
        <li class="first-line"><label>操作菜单：</label><input id="title" name="title" type="text" maxlength="50"
                                                          class="input-medium" value="${log.title}"/></li>
        <li class="first-line"><label>操作用户：</label><input id="createBy.name" name="createBy.name" type="text"
                                                          maxlength="50" class="input-medium"
                                                          value="${log.createBy.name}"/></li>
        <li class="first-line"><label>URI：</label><input id="requestUri" name="requestUri" type="text" maxlength="50"
                                                         class="input-medium" value="${log.requestUri}"/></li>
        ...
        <li class="second-line" style="float: right"><label for="exception"><input id="exception" name="exception"
    ...
    <ul>
        ...
        <shiro:hasPermission name="sys:log:export">
            <a href="javascript:;" id="btnExport" class="btn btn-export"
               style="width: 49px;display:inline-block;float: right;margin-left: 20px;margin-bottom: 20px;margin-right: 14px">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-gradient">
        <thead>
        <tr>
            <th><input id="allboxs" onclick="allcheck1()" type="checkbox"/></th>
            <th>操作菜单</th>
            <th>操作用户</th>
            <th>所在组织机构</th>
            <th>所在部门</th>

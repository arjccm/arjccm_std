...
<body>
	<ul class="nav nav-tabs">
		<li><a style="text-align:center" href="${ctx}/sys/office/list?id=${office.parent.id}&parentIds=${office.parentIds}&name=${office.id}">机构列表</a></li>
		<li class="active"><a class="nav-head" href="${ctx}/sys/office/form?id=${office.id}&parent.id=${office.parent.id}">机构<shiro:hasPermission name="sys:office:edit">${not empty office.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:office:edit">查看</shiro:lacksPermission></a></li>
	</ul>

		...
		<c:forEach items="${page.list}" var="ccmFontUser">
			<tr>
				...
				<shiro:hasPermission name="cms:ccmFontUser:edit"><td>
					<a href="${ctx}/cms/ccmFontUser/delete?id=${ccmFontUser.id}"  title="注销" onclick="return confirmx('确认要删除该居民用户吗？', this.href)"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>

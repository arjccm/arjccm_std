    		...
    		html+='</div>';
             ...
             /* 	html+='<div class="unit-num">';
                 ...
                 if(residentialUnitArr[j]>1){
                     html+='<td><span>'+residentialUnitArr[j]+'单元<a class="btnList" title="删除该单元" onclick="removeUnit('+residentialUnitArr[j]+')"><i class="iconfont icon-icondaohangtubiao-shujucaijifenxi"></i></a></span></td>';
                 }else{

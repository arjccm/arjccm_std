...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/stepinfo/bphStepInfo/">数据列表</a></li>
		<shiro:hasPermission name="stepinfo:bphStepInfo:edit"><li><a style="text-align:center" href="${ctx}/stepinfo/bphStepInfo/form">数据添加</a></li></shiro:hasPermission>
	</ul>

...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="ccmReliefTask">
        <tr>
            ...
            <shiro:hasPermission name="relief:ccmReliefTask:edit">
                <td>
                    <a href="${ctx}/relief/ccmReliefTask/form?id=${ccmReliefTask.id}"><i style="color:#2fa4e7;" class="iconfont icon-caozuotubiao-xiugai" title="修改"></i></a>
                    <a href="${ctx}/relief/ccmReliefTask/delete?id=${ccmReliefTask.id}"
                       onclick="return confirmx('确认要删除该备勤任务吗？', this.href)"><i style="color:red;" class="iconfont icon-caozuotubiao-shanchu" title="删除"></i></a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>

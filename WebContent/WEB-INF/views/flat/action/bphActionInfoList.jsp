...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/action/bphActionInfo/">执行动作列表</a></li>
		<shiro:hasPermission name="action:bphActionInfo:edit"><li><a style="text-align:center" href="${ctx}/action/bphActionInfo/form">执行动作添加</a></li></shiro:hasPermission>
	</ul>

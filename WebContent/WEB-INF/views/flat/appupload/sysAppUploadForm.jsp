...
<div class="back-list clearfix">
    <ul class="nav nav-tabs">
        ...
        <li class="active" style="width: 150px"><a class="nav-head"
                                                   href="${ctx}/appupload/sysAppUpload/form?id=${sysAppUpload.id}">数据<shiro:hasPermission
                name="appupload:sysAppUpload:edit">${not empty sysAppUpload.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="appupload:sysAppUpload:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <form:form id="inputForm" modelAttribute="sysAppUpload" action="${ctx}/appupload/sysAppUpload/save" method="post"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:select path="type" class="input-xlarge required">
                    ...
                    <form:options items="${fns:getDictList('app_os_type')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="version" htmlEscape="false" type="number" maxlength="10"
        ...
        <div class="form-actions">
            <shiro:hasPermission name="appupload:sysAppUpload:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                           type="submit"

					...
					<tr>
						...
						<shiro:hasPermission name="resource:plmOtherResource:edit">
							...
							<a class="btnList"
								...
								onclick="return confirmx('确认要删除该资源共享吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a></td>
						</shiro:hasPermission>
					</tr>
				</c:forEach>
			</tbody>
						...
						<div class="footbtn" style="text-align: right;">
							<shiro:hasPermission name="resource:plmOtherResource:edit">
								<a class="btnList"
									...
									onclick="return confirmx('确认要删除该资源共享吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>
							</shiro:hasPermission>
						</div>
					</div>
				</div>

...
<body>
	<form:form id="inputForm" modelAttribute="plmApplyForReimbursement" action="${ctx}/travel/plmApplyForReimbursement/saveAudit" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			...
			<a id="btnConmit" class="btn btn-primary" onclick="javascript:;agree()"><i class="icon-ok-sign"></i>同 意</a>&nbsp;
			<c:if test="${rejectedBtn}">
			<a id="btnCancel" class="btn btn-inverse" onclick="javascript:;refuse()"><i class="iconfont icon-caozuotubiao-shanchu"></i>驳 回</a>&nbsp;
			</c:if>	

...
<form:form id="inputForm" cssStyle="padding-top: 20px" modelAttribute="kpiSchemeKpi"
           action="${ctx}/scheme/kpiSchemeKpi/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
        ...
        <div class="controls">
            <c:if test="${empty kpiSchemeKpi.id }">
                <form:select path="type" class="input-xlarge required">
                    <form:options items="${fns:getDictList('kpi_scheme_kpi_type')}" itemLabel="label" itemValue="value"
                                  htmlEscape="false"/>
                </form:select>
            </c:if>
    ...
    <shiro:hasPermission name="scheme:kpiSchemeKpi:edit">
        <div class="form-actions">
            ...
            <input id="btnRelationship" style="background:#D69601" class="btn btn-primary" onclick="relationship()"
                   type="button" value="考评关系"/>&nbsp;

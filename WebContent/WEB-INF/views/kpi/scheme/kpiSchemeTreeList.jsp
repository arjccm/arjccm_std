...
<div class="back-list clearfix">
    ...
    <div class="clearfix pull-right btn-box">
        <a href="javascript:;" id="btnSubmit" class="btn btn-primary"
           style="width: 49px;display:inline-block;float: right;margin-left: 20px;margin-right: 14px;margin-bottom: 20px">
    ...
    <div class="row-fluid" style="margin-top: 60px">
        ...
        <div class="span8 kpi-bg">
            ...
            <div style="height:650px;overflow: hidden;width:100%">
                <div class="index-style2" id="index-details"
                     style="margin-left:5%;width:88%;height:100%;overflow: auto">
                    ...
                    <%--<iframe id="indexDetailsIframe" name="indexDetailsIframe" src="${ctx}/scheme/kpiScheme/formDap?id=f6e70eca9d8148dbb27a399ecca2e167"--%>
                            style="overflow: visible;" scrolling="yes" frameborder="no" width="100%" height="90%"

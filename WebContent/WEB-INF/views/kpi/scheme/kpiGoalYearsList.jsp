...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/scheme/kpiGoalYears/">数据列表</a></li>
		<shiro:hasPermission name="scheme:kpiGoalYears:edit"><li><a style="text-align:center" href="${ctx}/scheme/kpiGoalYears/form">数据添加</a></li></shiro:hasPermission>
	</ul>

...
<body>
<shiro:hasPermission name="scheme:kpiSchemeKpi:edit">
    <h5 class="nav nav-tabs ">
        绩效考评方案${not empty kpiScheme.id?'修改':'添加'}
    </h5>
</shiro:hasPermission>

<form:form id="inputForm" cssStyle="padding-top: 10px" modelAttribute="kpiScheme"
           action="${ctx}/scheme/kpiScheme/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="startTime" type="text" id="startTime" readonly="readonly" maxlength="20"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="endTime" type="text" id="endTime" readonly="readonly" maxlength="20"
                   class="input-medium Wdate required"
    ...
    <div class="control-group">
        <label class="control-label width:182px"><span class="help-inline"><font
                color="red">*</font> </span>考核人员类别：</label>
        <div class="controls">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="state" class="input-xlarge required" disabled="true">
                <form:options items="${fns:getDictList('kpi_scheme_state')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/>
            </form:select>
        </div>
    </div>

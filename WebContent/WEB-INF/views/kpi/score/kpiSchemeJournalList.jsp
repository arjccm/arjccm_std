...
<div class="back-list clearfix">
	<ul class="nav nav-tabs">
		<li class="active"><a class="nav-head" href="${ctx}/score/kpiSchemeJournal/">数据列表</a></li>
		<shiro:hasPermission name="score:kpiSchemeJournal:edit"><li><a style="text-align:center" href="${ctx}/score/kpiSchemeJournal/form">数据添加</a></li></shiro:hasPermission>
	</ul>

		...
		<c:forEach items="${page.list}" var="riskEventGreat">
			<tr>
				...
				<shiro:hasPermission name="report:riskEventGreat:edit"><td>
					...
					<a class="btnList" href="${ctx}/report/riskEventGreat/deleteDatabase?id=${riskEventGreat.id}" onclick="return confirmx('确认要删除该库的重大事项吗？', this.href)" title="删除"><i class="iconfont icon-caozuotubiao-shanchu"></i></a>

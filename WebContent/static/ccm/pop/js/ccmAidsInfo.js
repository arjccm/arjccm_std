...
$(function() {
	...
	function showEchart() {
		...
		$.post(context + "/report/ccmPeopleStat/personStat", {
            ...
            lowLevelNew = data["所有下级区域本月艾滋病危险人员新增人数"];
            lowLevelAll = data["所有下级区域本月艾滋病危险人员总数"];
			// 图表1 数据
			...
			// 生成图表
			$.myChartPeopleAmountElse(title1, ajaxDataX1, seriesDate1, myChart1,"艾滋病危险人员人数",40,areaToContent);

...
$(function() {
	...
	function showEchart() {
		...
		$.post(context + "/report/ccmPeopleStat/personStat", {
            ...
            lowLevelNew = data["所有下级区域本月社区矫正新增人数"];
            lowLevelAll = data["所有下级区域本月社区矫正总数"];
			// 图表1 数据
			...
			// 生成图表
			$.myChartPeopleAmountElse(title1, ajaxDataX1, seriesDate1, myChart1,"社区矫正人数",40,areaToContent);

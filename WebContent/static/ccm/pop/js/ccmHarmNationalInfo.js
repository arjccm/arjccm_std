...
$(function() {
	...
	function showEchart() {
		...
		$.post(context + "/report/ccmPeopleStat/personStat", {
            ...
            lowLevelNew = data["所有下级区域本月有危害国家安全活动嫌疑新增人数"];
            lowLevelAll = data["所有下级区域本月有危害国家安全活动嫌疑总数"];
			// 图表1 数据
			...
			// 生成图表
			$.myChartPeopleAmountElse(title1, ajaxDataX1, seriesDate1, myChart1,"有危害国家安全活动嫌疑人数",40,areaToContent);

...
$(function() {
	...
	function showEchart() {
		...
		$.post(context + "/report/ccmPeopleStat/personStat", {
            ...
            lowLevelNew = data["所有下级区域本月故意犯法释放新增人数"];
            lowLevelAll = data["所有下级区域本月故意犯法释放总数"];
			// 图表1 数据
			...
			// 生成图表
			$.myChartPeopleAmountElse(title1, ajaxDataX1, seriesDate1, myChart1,"故意犯法释放人数",40,areaToContent);

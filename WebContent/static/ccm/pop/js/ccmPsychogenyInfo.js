...
$(function() {
	...
	function showEchart() {
		...
		$.post(context + "/report/ccmPeopleStat/personStat", {
            ...
            lowLevelNew = data["所有下级区域本月肇事肇祸等严重精神障碍患者新增人数"];
            lowLevelAll = data["所有下级区域本月肇事肇祸等严重精神障碍患者总数"];
			// 图表1 数据
			...
			// 生成图表
			$.myChartPeopleAmountElse(title1, ajaxDataX1, seriesDate1, myChart1,"肇事肇祸等严重精神障碍患者人数",40,areaToContent);
